...
<Steps>
  ...
  <Step title="Choose your parsers">
    ...
    - **Tool call parsing** extracts `tool_calls` from a model that emits tool-call markup. See [Tool Call Parsing](README.md).
...
- [Tool Call Parsing](README.md) — Dynamo-native tool-call parser names and request examples
