...
def main() -> None:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            hovertemplate=(
                "<b>interval %{x:.0f} s</b><br>" "p90 TTFT %{y:,.0f} ms<extra></extra>"
            ),
            showlegend=False,
            name="p90 TTFT",
        )
    ...
    fig.update_xaxes(
        type="log",
        title=dict(
            text="load_adjustment_interval (s, log)",
