...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="regular camera"
    href="/dynamo/dev/blog/dynamo-snapshot"
  >
    Checkpoint/restore for inference workers, plus a per-GPU memory service that
    decouples weight restoration from process restore — bringing startup to under 5 seconds.
  </Card>
</CardGroup>
