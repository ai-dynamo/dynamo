...
| [Request Replay Tracing](request-tracing.md) | Per-request trace capture for direct DynoSim replay and optional payload logging | `DYN_REQUEST_TRACE`, `DYN_REQUEST_TRACE_SINKS`, `DYN_REQUEST_TRACE_FILE_PATH`, `DYN_REQUEST_TRACE_INCLUDE_REQUEST_RESPONSE` |
