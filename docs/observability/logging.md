...
| `DYN_SDK_DISABLE_ANSI_LOGGING` | Disable ANSI color codes in log output. Use in Docker or non-TTY environments for plain-text logs without switching to JSONL | `false` | `true` |
