 ...
 *
 *   The fix flattens the nav (docs/fern/index.yml) back to stable
 ...
 *   cloned from the on-page <DepMetadata> pill (docs/fern/main.css
 ...
 *   time by docs/fern/scripts/sync_deps.py into docs/fern/js/dep-status-data.js
 ...
 *       matches the slug in docs/fern/index.yml.
 ...
 *   pattern in docs/fern/js/dep-pr-comments.js for the origin of this shape.
 */
(function () {
  "use strict";
  ...
  // The pill uses `margin-left: auto` (see docs/fern/main.css) to push itself
   ...
   *
   * MUST match `statusVariant()` in docs/fern/components/DepMetadata.tsx
