 ...
 *   docs/fern/components/DepIndex.tsx on docs/fern/pages/proposals/registry.mdx. Each card links
 *   to the DEP's stable /proposals/<slug> page.
 *
 * DATA SOURCE
 *   `window.__DEP_INDEX` — a list of per-DEP records emitted at build time by
 *   docs/fern/scripts/sync_deps.py into docs/fern/js/dep-index-data.js (loaded first via
 ...
 *   the build idempotent. Mirrors the shape of docs/fern/js/dep-status-pills.js.
 */
(function () {
  "use strict";
   ...
   * MUST match statusVariant() in docs/fern/components/DepMetadata.tsx and
   * variant() in docs/fern/js/dep-status-pills.js VERBATIM.
   */
