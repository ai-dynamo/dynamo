...
[Simulate a Kubernetes Deployment](../../dynosim/mocker.md) or
[Simulate a Local Deployment](../../dynosim/mocker-local.md); for the engine internals these flags
...
<CardGroup cols={2}>
  <Card title="Simulate a Kubernetes Deployment" icon="server" href="../../dynosim/mocker.md">
    Deploy and run the Mocker worker on Kubernetes.
  </Card>
  <Card title="Simulate a Local Deployment" icon="terminal" href="../../dynosim/mocker-local.md">
    Run a frontend and Mocker worker from the command line.
  </Card>
  <Card title="Run a DynoSim Simulation" icon="play" href="../../dynosim/runs.md">
