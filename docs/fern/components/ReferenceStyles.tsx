...
/* Pairwise feature matrix — matches the feature-by-backend heatmap vocabulary
   while preserving the wide table's horizontal scroll behavior. */
.dynref-interaction-panel {
    padding: 16px;
    overflow-x: auto;
}

.dynref-interaction-panel table {
    width: max-content;
    min-width: 100%;
    margin: 0;
...
.dynref-interaction-panel th,
.dynref-interaction-panel td {
    min-width: 76px;
    height: 34px;
    padding: 5px 8px;
    border: 1px solid transparent;
...
.dynref-interaction-panel th:first-child,
.dynref-interaction-panel td:first-child {
    position: sticky;
    left: 0;
    z-index: 2;
    min-width: 148px;
    background: var(--pst-color-surface);
    box-shadow: 0 0 0 4px var(--pst-color-surface);
    color: var(--pst-color-text-base);
    text-align: left;
}

.dark .dynref-interaction-panel th {
    background: #242424;
}

.dark .dynref-interaction-panel th:first-child,
.dark .dynref-interaction-panel td:first-child {
    background: #161616;
    box-shadow: 0 0 0 4px #161616;
}

.dynref-interaction-panel td:has(.dynref-interaction--yes) {
    background: var(--dynref-green-bg);
    border-color: var(--dynref-green-border);
}

.dynref-interaction-panel td:has(.dynref-interaction--wip) {
    border: 1.5px dashed var(--dynref-amber-dash);
}

.dynref-interaction-panel td:has(.dynref-interaction--na) {
    background: rgba(120, 120, 120, 0.08);
}

.dynref-interaction-panel td:has(.dynref-interaction--no) {
    background: #ececec;
}

.dark .dynref-interaction-panel td:has(.dynref-interaction--no) {
    background: #242424;
}
...
.dynref-interaction--no,
.dynref-interaction--na { color: var(--pst-color-text-muted); }

.dynref-interaction-note-mark {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    width: 12px;
