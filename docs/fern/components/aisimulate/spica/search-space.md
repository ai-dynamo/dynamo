...
The Dynamo adapter schemas are defined in
[`components/src/dynamo/planner/simulation/adapter.py`](https://github.com/ai-dynamo/dynamo/blob/main/components/src/dynamo/planner/simulation/adapter.py)
and
[`components/src/dynamo/router/simulation/adapter.py`](https://github.com/ai-dynamo/dynamo/blob/main/components/src/dynamo/router/simulation/adapter.py).
