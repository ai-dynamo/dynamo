 ...
 * runtime lives in `docs/fern/js/dep-index.js` (injected site-wide via docs.yml
 * `js:`); it reads the build-time dataset `window.__DEP_INDEX` (emitted by
 * docs/fern/scripts/sync_deps.py into docs/fern/js/dep-index-data.js) and renders a
...
export function DepIndex() {
  return (
    <div id="dep-index" className="dep-index">
      ...
      {/* Runtime (docs/fern/js/dep-index.js) renders the head + filters + grid here
