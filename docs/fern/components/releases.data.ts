...
export const MODEL_EA_BUILDS: ModelEaBuild[] = [
  ...
  },
  {
    ...
    statusLine: "The v1.3.0 TensorRT-LLM release container supports the published deployment examples.",
    recipeLabel: "Deployment examples (main)",
    recipeHref: "https://github.com/ai-dynamo/dynamo/tree/main/examples/deployments/kubernetes",
