...
See [Auto Deploy with DGDR](../kubernetes/dgdr-guide.md) for the task-oriented workflow and the
[DGDR Reference](../kubernetes/dgdr-reference.mdx) for field definitions, lifecycle phases, and
validation behavior.
