...
The stack is now installed. Continue with the [Metrics and Dashboards](../observability/metrics.mdx),
[Tracing](../observability/tracing.mdx), or [Logging](../observability/logging.mdx) guide to configure a
Dynamo deployment to emit each signal. For service ports and configuration files, see the
