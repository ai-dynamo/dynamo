...
Build Dynamo from source when you want to contribute code, test features on the development branch, or customize the build. If you just want to run Dynamo, the [Install Dynamo](../getting-started/local-installation.mdx) guide is faster.
