...
<Info>
Connection refused? The frontend takes a few seconds to start — retry. For production liveness and readiness probes, see [Health Checks](../observability/health-checks.mdx).
</Info>
