...
Your cluster is ready. Follow the **[Model Deployment](../getting-started/kubernetes-deployment.mdx)** to choose between applying a tuned DGD recipe, creating a DGD directly, or using DGDR to generate one.
