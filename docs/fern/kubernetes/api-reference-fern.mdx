...
<ParamField path="planner" type="RawExtension">
  Planner contains the raw Planner configuration passed to the Planner service.<br />Its schema is defined by dynamo.planner.config.planner_config.PlannerConfig.<br />See [Planner Guide](../components/planner/planner-guide.md#plannerconfig-reference).<br />DGDR passes this object through without field-level validation; the Planner<br />service validates it at startup.<br />The presence of this field (non-null) enables the planner in the generated DGD.
