...
For worked examples — per-component env overrides, enabling KV-aware routing on the generated frontend, worker KV-event publication, and EPP/gateway topologies — see [DGDR Examples](dgdr-examples.md), [Router Guide](../components/router/router-guide.md), and [Gateway API Inference Extension](inference-gateway.md).
