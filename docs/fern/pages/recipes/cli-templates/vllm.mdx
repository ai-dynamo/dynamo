...
rejects `voice`, `ref_audio`, and `ref_text`, and accepts an optional `cfg_scale` for
classifier-free guidance. The printed curl example adapts to the selected model. See
