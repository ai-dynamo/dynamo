...
<Accordion title="agg_embed.yaml · Aggregated embedding serving (/v1/embeddings)">
This Kubernetes template uses `Qwen/Qwen3-Embedding-0.6B`; the local CLI example defaults to `Qwen/Qwen3-Embedding-4B`.
