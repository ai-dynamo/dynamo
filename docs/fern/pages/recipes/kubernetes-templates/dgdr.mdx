...
<AccordionGroup>
  ...
  <Accordion title="model-cache.yaml · Load weights from a shared PVC">
    Mounts a pre-populated model cache into the profiling job and generated workers. Set the
    backend runtime image and create the PVC before applying the request.
