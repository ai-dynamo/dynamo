...
<span><b>Spec decode</b> MTP3</span>
<span><b>KV transfer</b> NIXL over UCX (cuda_copy + cuda_ipc + tcp)</span>
...
See the [recipe README](https://github.com/ai-dynamo/dynamo/tree/main/recipes/qwen3.8-flash-next) for full smoke tests including tool calling and image input.
