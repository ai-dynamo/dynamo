...
<span><b>GPUs</b> 4x B200 per worker (4 workers), 16 total</span>
...
<span><b>Checkpoint</b> nvidia/GLM-5.2-NVFP4</span>
<span><b>Precision</b> NVFP4 + FP8 KV cache</span>
<span><b>GPUs</b> 4x B200 per prefill worker (3 workers) + 8x B200 decode (1 worker), 20 total</span>
...
<span><b>GPUs</b> 8x H200 per worker (3 workers), 24 total</span>
...
<span><b>Checkpoint</b> zai-org/GLM-5.2-FP8</span>
<span><b>Precision</b> FP8 + FP8 KV cache</span>
<span><b>GPUs</b> 8x H200 prefill (1 worker) + 8x H200 decode (1 worker), 16 total</span>
