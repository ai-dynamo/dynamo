...
Refresh profiles are aggregated agentic deployments with two workers, KV-aware routing, prefix caching, asynchronous scheduling, FP8 KV cache, BF16 Mamba state, and Expert Parallelism disabled. The 256K profiles use five-token MTP; the 1M profiles run without MTP.
...
| GPU | Context | Worker shape | Reference concurrency | Manifest |
|---|---:|---:|---:|---|
| B200 | 256K | 2 × TP4 | 94 | `vllm/agg-b200-agentic-256k-2w-kv/deploy.yaml` |
| B200 | 1M | 2 × TP4 | 46 | `vllm/agg-b200-agentic-1m-2w-kv/deploy.yaml` |
| GB200 | 256K | 2 × TP4 | 96 | `vllm/agg-gb200-agentic-256k-2w-kv/deploy.yaml` |
| GB200 | 1M | 2 × TP4 | 48 | `vllm/agg-gb200-agentic-1m-2w-kv/deploy.yaml` |
| H200 | 256K | 2 × TP8 | 64 | `vllm/agg-h200-agentic-256k-2w-kv/deploy.yaml` |
| H200 | 1M | 2 × TP8 | 32 | `vllm/agg-h200-agentic-1m-2w-kv/deploy.yaml` |
...
All six profiles share one benchmark Job and runner:
