...
| B200 | 1M | Disaggregated | 1P TP4 + 1D TP4 | 24 | `vllm/disagg-b200-agentic-1m-1p1d/deploy.yaml` |
| GB200 | 256K | Disaggregated | 1P TP4 + 1D TP4 | 64 | `vllm/disagg-gb200-agentic-256k-1p1d/deploy.yaml` |
| GB200 | 1M | Disaggregated | 1P TP4 + 1D TP4 | 24 | `vllm/disagg-gb200-agentic-1m-1p1d/deploy.yaml` |
| H200 | 256K | Disaggregated | 1P TP8 + 1D TP8 | 36 | `vllm/disagg-h200-agentic-256k-1p1d/deploy.yaml` |
| H200 | 1M | Disaggregated | 1P TP8 + 1D TP8 | 16 | `vllm/disagg-h200-agentic-1m-1p1d/deploy.yaml` |
