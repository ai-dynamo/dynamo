...
Not yet validated on the shared trace. A synthetic 64K / 400 / 90%-reuse profile measures 25.0 system tok/s/GPU at user output 53.0 tok/s (concurrency 4, single run).

</div>

<div data-sku="h200" data-variant="disagg">

Not yet validated on the shared trace. A synthetic 64K / 400 / 90%-reuse profile puts the SLA crossing near concurrency 6, at 19.9 system tok/s/GPU (single run).
...
| `agg-h200-agentic` | 8x H200 | Aggregated | 1,048,576 | Synthetic only |
