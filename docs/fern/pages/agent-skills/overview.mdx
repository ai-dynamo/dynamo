...
"Deploy Llama-3.3-70B on my 4-GPU node and confirm it serves traffic."
"My TTFT doubled after I raised concurrency. Diagnose it and fix the config."
```

## Deployment skills

Skills for creating, inspecting, and debugging DynamoGraphDeployments: `dep-create`,
`dep-status`, and `debug-session`. Ask your agent to deploy a model or investigate a broken
deployment and these guide the work. Sources live under
...
before spending GPU time, and iterates within budgets you set (GPU-hours, wall clock, failed
...
Setup and additional debugging skill families will join this page as they land.
