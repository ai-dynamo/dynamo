...
| `strict_priority` | Router pending-queue tier. Higher values always precede lower values; a classifier-provided `due_at` breaks ties within a tier before the configured queue policy is applied. |
