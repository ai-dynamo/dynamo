...
The strict tier is compared first. A classifier-provided `due_at` breaks ties within that tier before FCFS, LCFS, or Weighted Shortest Processing Time (WSPT) applies its configured policy key.
