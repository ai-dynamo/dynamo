...
| [SLIME](https://github.com/THUDM/slime) | Experimental fixed fleet | [Streaming external rollouts in Slime](https://github.com/THUDM/slime/pull/2272) with stock SGLang engines managed by Dynamo sidecars | The [fixed-fleet example](https://github.com/ai-dynamo/dynamo/blob/main/examples/README.md#integration-examples) uses the Slime router and static engine Services. Dynamo frontend routing, elastic discovery, and external-engine recovery are not integrated. |
