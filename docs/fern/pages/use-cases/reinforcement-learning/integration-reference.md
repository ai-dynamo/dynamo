...
| Prime-RL | Newer adapter [PR #3296 at `f687696`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3296) stacked on draft native-transfer [PR #3260 at `8bd4790`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3260); research runbook [PR #3213 at `33d5cda`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3213); earlier discovery/recipe/sidecar PRs [#3176 at `828ddc7`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3176), [#3180 at `2f67c72`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3180), and [#3181 at `b17ceea`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3181); open Dynamo umbrella [#13481 at `b3d6a63`](https://github.com/ai-dynamo/dynamo/pull/13481) | Intended frontend inference plus per-engine discovery, health, pause/resume, version fencing, and control | Proposed filesystem, external NIXL, and native NCCL paths; #3296 records one branch-level NIXL update and post-update rollout | External Dynamo/vLLM sidecar recipes; #3296's recorded run uses Kubernetes, while #3213 also proposes a local and Slurm-managed path; final accepted deployment and release contract unresolved | Integration in progress | 2026-08-27; #3296 records a two-step Qwen3-MoE GRPO run and focused component tests, but it is stacked on open draft #3260 and composes open Dynamo/vLLM dependencies. #3213 explicitly leaves its full source build and two-GPU run open; no released independent reproduction exists | Prime-RL integration contributors and Dynamo RL maintainers |
