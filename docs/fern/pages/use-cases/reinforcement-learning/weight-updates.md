...
| Prime-RL proposals | Filesystem, external NIXL, and native NCCL paths in [open adapter PR #3296 at `f687696`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3296) | Proposed Dynamo discovery plus per-engine health, pause/resume, version fencing, and control | Integration in progress. #3296 is stacked on [open draft native-transfer PR #3260 at `8bd4790`](https://github.com/PrimeIntellect-ai/prime-rl/pull/3260) and composes open Dynamo/vLLM dependencies; its branch-level run is not a released or independent validation record. |
