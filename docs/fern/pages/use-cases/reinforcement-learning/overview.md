...
| Slime | Experimental fixed worker set | Use the [Slime fixed-worker-set example](https://github.com/ai-dynamo/dynamo/blob/main/examples/README.md#integration-examples) with the streaming external-rollout support from Slime. |
