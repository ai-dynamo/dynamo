...
settings. For shared workload, engine, topology, and report arguments, see the
[AI Simulate Replay CLI Reference](../../../developer-guide/knowledge-base/modular-components/ai-simulate-experimental/replayer-experimental/cli-reference.md).
For Router, Planner, and online extensions, see the
[Dynamo Replay CLI Reference](../../../reference/components/dynosim-replay-cli-reference.mdx).
