...
Dynamo discovery.
> [!IMPORTANT]
> **Deprecation:** Dynamo no longer provides the Go-based EPP. The former
> `deploy/inference-gateway/epp/` Go EPP tree has been removed. Dynamo EPP is now written in Rust and remains a part of the FrontEnd image.
