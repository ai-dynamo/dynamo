...
read the named TCP `replica-agg` contract from their Service and use its EndpointSlices to discover
sibling pod IPs and resolve a named backend `targetPort`.
