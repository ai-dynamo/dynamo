...
|---|---|---|
| `min_endpoint` | `1` | Legacy shared replica floor and the floor for aggregated mode. |
| `prefill_min_endpoint` | `null` | Prefill replica floor for disaggregated or prefill-only mode; inherits `min_endpoint` when unset. |
| `decode_min_endpoint` | `null` | Decode replica floor for disaggregated or decode-only mode; inherits `min_endpoint` when unset. |
