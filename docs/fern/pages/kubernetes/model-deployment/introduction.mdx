...
<CardGroup cols={2}>
  <Card title="Start from an Example" icon="regular book-open" href="https://github.com/ai-dynamo/dynamo/tree/main/examples/deployments/kubernetes">
    Use a maintained backend and topology manifest that matches your model, GPU, and serving topology.
  </Card>
