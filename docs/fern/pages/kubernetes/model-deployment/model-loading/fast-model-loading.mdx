...
- [Snapshotting GPU Workers](../../../developer-guide/knowledge-base/kubernetes/kubernetes-operator/snapshot.md) — checkpoint/restore and warm-start options for repeated restarts
