...
This aggregated GPT-OSS-120B worker offloads KV blocks to host memory via SimpleCPUOffload. See the [vLLM B200 agentic recipe](https://github.com/ai-dynamo/dynamo/blob/main/recipes/gpt-oss-120b/vllm/agg-b200-agentic/deploy.yaml) for a production-oriented example:
