...
This aggregated Qwen3-32B worker offloads KV blocks to 100 GB of host memory. A maintained [KV-cache-offload deployment example](https://github.com/ai-dynamo/dynamo/tree/main/examples/deployments/kubernetes/llm/vllm/kv-cache-offload-qwen3-32b) provides the complete manifest set:
