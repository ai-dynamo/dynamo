...
- Python 3.11 through 3.13 with AISimulate installed. From the Dynamo checkout root, install its
  declared dependency, which provides the retained `aiconfigurator` sizing command:
