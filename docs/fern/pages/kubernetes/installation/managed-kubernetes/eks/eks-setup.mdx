...
```bash
# Example: cache the GPT-OSS-120B model which we will be using later
cp ../../../recipes/gpt-oss-120b/model-cache/model-download.yaml manifests/model-download/model-download.yaml
