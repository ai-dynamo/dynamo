...
Dynamo Enterprise Support identifies a curated set of NVIDIA Dynamo release artifacts that are eligible for NVIDIA Enterprise Support. It is a publishing and support designation, not a separate Dynamo fork, feature tier, or runtime implementation.
...
Dynamo Enterprise Support artifacts are published on NVIDIA NGC as public images. Downloading and running them does not require an [NVIDIA AI Enterprise](https://docs.nvidia.com/ai-enterprise/) subscription. An active NVIDIA AI Enterprise subscription is required to open commercial support cases against those artifacts.

| Activity | Requirement |
| --- | --- |
| Access and download Dynamo Enterprise Support artifacts | No NVIDIA AI Enterprise subscription required |
