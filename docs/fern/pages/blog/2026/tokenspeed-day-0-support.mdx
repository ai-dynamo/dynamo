...
Use the TokenSpeed backend documentation and pin the backend version in your deployment configuration; this repository does not maintain a model-specific TokenSpeed manifest.
