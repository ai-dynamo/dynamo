...
> **Using an AI coding agent?** This repository ships agent skills for performance work: clone
> the repo, point Claude Code, Codex, or Cursor at it, and describe your deployment and goal in
> plain language. The skills activate automatically and guide the agent through deploying,
> benchmarking with AIPerf, and iterating on configuration with evidence at every step.
