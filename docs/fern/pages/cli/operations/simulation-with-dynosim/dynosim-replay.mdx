...
[Simulate a Local Deployment with Mocker](mocker-live-simulation.mdx). The former Replay online mode
remains unavailable. For the configuration and output contract, see the
