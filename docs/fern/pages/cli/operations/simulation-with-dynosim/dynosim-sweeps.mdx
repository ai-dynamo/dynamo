...
2. Deploy the candidate on the target hardware and benchmark it with AIPerf using either the
...
Online validation with Mocker is temporarily unavailable and will return in a future release.
</Step>
</Steps>
