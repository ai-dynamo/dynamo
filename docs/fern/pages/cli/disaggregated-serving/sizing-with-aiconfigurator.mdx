...
Use Python 3.11 through 3.13. From the Dynamo checkout root, install its declared AISimulate
dependency, which provides the retained `aiconfigurator` sizing command:
