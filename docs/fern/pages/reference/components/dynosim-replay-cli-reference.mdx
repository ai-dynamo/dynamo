...
the heuristic. For example, a marker at 1 second with a child timestamp of 2 seconds is
interpreted as 3 seconds with `relative`, and as 2 seconds with `absolute`.
