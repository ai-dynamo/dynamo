...
<Note>
  The operator does not currently provide first-class request-plane TLS
  injection. Mount the certificate material and set the environment variables
  on every participating component.
</Note>
...
in [Event-plane transport security](../../developer-guide/knowledge-base/concepts/communication-planes/event-plane.md#transport-security).
...
- [Request Plane](../../developer-guide/knowledge-base/concepts/communication-planes/request-plane.md) — Request transport behavior
- [Event Plane](../../developer-guide/knowledge-base/concepts/communication-planes/event-plane.md) — Event transport and NATS authentication
