...
For the Dynamo driver and runtime boundary, see
[Live Mocker Architecture](../../developer-guide/knowledge-base/modular-components/backends/mocker/mocker-engine-architecture.md).
For scheduler and KV-cache internals, see
[AI Simulate Engine Architecture](../../developer-guide/knowledge-base/modular-components/ai-simulate-experimental/engine-experimental/architecture.md).
...
For the timing-model design, see
[AI Simulate Engine Architecture](../../developer-guide/knowledge-base/modular-components/ai-simulate-experimental/engine-experimental/architecture.md#timing-models).
...
<CardGroup cols={2}>
  ...
  <Card title="Live Mocker Architecture" icon="diagram-project" href="../../developer-guide/knowledge-base/modular-components/backends/mocker/mocker-engine-architecture.md">
    Dynamo runtime integration around the shared AI Simulate engine.
  </Card>
