...
<ParamField path="min_endpoint" type="integer" default="1">
  Legacy shared minimum number of engine endpoints. Component-specific minimums inherit this value when unset. Aggregated mode always uses this field. Must be at least `1`.
</ParamField>
