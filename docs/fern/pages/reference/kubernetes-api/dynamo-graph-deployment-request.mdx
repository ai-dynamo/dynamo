...
Only `model` is unconditionally required by the schema. Other fields are optional, but generated component images without a parseable semantic-version tag require a runtime version override as described below.
