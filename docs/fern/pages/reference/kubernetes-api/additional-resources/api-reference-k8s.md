...
| `replicas` _integer_ | Replicas optionally declares the number of Pods of this role in one complete<br />component instance. When omitted, the enclosing component type must define<br />the derived count and its relationship to other component fields. |  | Minimum: 1 <br />Optional: \{\} <br /> |
