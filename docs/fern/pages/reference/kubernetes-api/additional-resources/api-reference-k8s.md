...
| `eppConfig` _[EPPConfig](#eppconfig)_ | Deprecated Go-EPP configuration. Omit for the native Rust EPP; kept for upgrade compatibility. Only applicable when ComponentType is "epp". |  | Optional: \{\} <br /> |
...
Deprecated: omit for the native Rust EPP; kept for upgrade compatibility.
...
| `eppConfig` _[EPPConfig](#eppconfig)_ | Deprecated Go-EPP configuration. Omit for the native Rust EPP; kept for upgrade compatibility. Only meaningful when `type` is `epp`. |  | Optional: \{\} <br /> |
