...
| `gpuCountPerPod` _integer_ | GPUCountPerPod is the number of GPUs requested by the main container in<br />each Pod, resolved from scalar resources or DRA ResourceClaims. |  | Minimum: 1 <br />Optional: \{\} <br /> |
