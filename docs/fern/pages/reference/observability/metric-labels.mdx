...
<ParamField path="decision" type="string">
  `[Shared]` On `dynamo_frontend_request_trace_sampling_records_total` — the source sampling result.

  <span className="enum-values"><span className="enum-label">Allowed values:</span> <Badge intent="note" minimal>retained</Badge> <Badge intent="note" minimal>dropped</Badge></span>
</ParamField>
...
<ParamField path="event_type" type="string">
  ...
  On `dynamo_frontend_request_trace_sampling_records_total`, identifies the request-trace row type.

  <span className="enum-values"><span className="enum-label">Allowed values:</span> <Badge intent="note" minimal>request_end</Badge> <Badge intent="note" minimal>request_payload</Badge> <Badge intent="note" minimal>tool_start</Badge> <Badge intent="note" minimal>tool_end</Badge> <Badge intent="note" minimal>tool_error</Badge></span>
</ParamField>
