...
Current stable release: v1.4.0 (container tag `1.4.0`, wheel version `1.4.0`).

**Backend engine pins per Dynamo release**

| Dynamo | Type | SGLang | TensorRT-LLM | vLLM | NIXL (SGL / TRT / vLLM) | UCX |
| --- | --- | --- | --- | --- | --- | --- |
| main (ToT) | development head | 0.5.17 | 1.3.0rc23 | 0.26.0 | 1.3.2 / 1.3.1 / 1.3.2 | - |
...
**Feature support by backend (v1.4.0)**
