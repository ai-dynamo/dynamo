...
The existing `WorkerSelectionPolicyRegistry` name, worker-only registration methods, and frontend factory setters remain available. An empty bundle retains the default selector and pass-through admission.
