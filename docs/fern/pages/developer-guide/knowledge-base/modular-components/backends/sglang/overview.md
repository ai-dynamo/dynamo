...
| [**LoRA**](../../../../../cli/operations/lora-adapters.md) | 🚧 | **Experimental.** Dynamic load/unload and aggregated serving are validated; disaggregated serving is not end-to-end validated |
...
> 4. **LoRA**: Dynamic adapter loading, unloading, discovery, and aggregated inference have pre-merge end-to-end coverage. Prefill/decode registration has unit coverage, but disaggregated LoRA and feature pairings such as KV-aware routing have not been validated end to end. ([Source](../../../../../cli/operations/lora-adapters.md))
