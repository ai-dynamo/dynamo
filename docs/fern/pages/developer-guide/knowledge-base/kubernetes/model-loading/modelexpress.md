...
| --- | --- |
| Small cluster or first deployment | [Model Caching](../../../../kubernetes/model-deployment/model-loading/model-caching.mdx) with PVC + download Job |
...
> [!NOTE]
> Dynamo vLLM and SGLang runtime images include ModelExpress v0.5.0. The bundled vLLM
> recognizes the `modelexpress` loader natively.
