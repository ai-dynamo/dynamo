...
The recommended way to deploy Planner is via `DynamoGraphDeploymentRequest` (DGDR). See the [SLA Planner Quick Start](../../modular-components/planner/planner-guide.md) for complete instructions.
...
For more details, see the [SLA Planner documentation](../../modular-components/planner/planner-guide.md).
...
> [Observability](../../../../kubernetes/operations/observability.mdx).
...
- [Planner Documentation](../../modular-components/planner/planner-guide.md)
