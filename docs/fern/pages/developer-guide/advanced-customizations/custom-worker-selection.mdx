...
The [basic policy](https://github.com/ai-dynamo/dynamo/blob/main/examples/router/custom-policy-example/basic/src/lib.rs) shows one scorer and picker. The [disaggregated policy](https://github.com/ai-dynamo/dynamo/blob/main/examples/router/custom-policy-example/disaggregated/src/lib.rs) shows separate implementations for prefill and decode workers.
