...
Full result tables are reproduced below from the [source study](https://github.com/ai-dynamo/dynamo/blob/main/docs/fern/benchmarks/embedding_cache.md); the headline numbers:
