...
<ParamField path="dynamo_component_kv_dc_relay_serving_readiness_binding_count" type="gauge">
  Current advertised canonical model registrations by serving-readiness
  [`state`](metric-labels.mdx#state).
</ParamField>
