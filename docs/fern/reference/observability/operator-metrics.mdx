...
- [Operator Metrics guide](../../kubernetes/observability/operator-metrics.md) — setup, example queries, and the operator Grafana dashboard.
- [Kubernetes Metrics guide](../../kubernetes/observability/metrics.md) — PodMonitor and Prometheus walkthrough for application metrics.
