...
To run the exact configuration shown in the blog post, you can view the commands created by the SGLang team [here](https://github.com/sgl-project/sglang/issues/6017).
...
> [!Note]
> Please ensure that you are building this on an AMD64 machine since H100 is ARM64 only. The correct SGLang image will automatically be pulled for you since they ship a manifest with both x86_64 and ARM64 images.
