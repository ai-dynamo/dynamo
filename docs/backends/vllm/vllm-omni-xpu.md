...
```bash
bash examples/backends/vllm/launch/xpu/agg_omni_image_xpu.sh
```
...
```bash
bash examples/backends/vllm/launch/xpu/agg_omni_video_xpu.sh
```
...
```bash
bash examples/backends/vllm/launch/xpu/agg_omni_i2v_xpu.sh
```
...
```bash
bash examples/backends/vllm/launch/xpu/agg_omni_audio_xpu.sh
```
...
```bash
bash examples/backends/vllm/launch/xpu/agg_omni_audio_xpu.sh --model Qwen/Qwen3-TTS-12Hz-1.7B-VoiceDesign
