...
Deploy your DynamoGraphDeployments separately using the [deployment documentation](../kubernetes). Each deployment should have a frontend service exposed.
...
Deploy your DynamoGraphDeployment using the [deployment documentation](../kubernetes/). Ensure it has a frontend service exposed.
