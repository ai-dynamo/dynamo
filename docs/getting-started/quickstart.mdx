...
<Note>
The steps below run inside the container. If you installed the wheel instead, run the same `python3 -m dynamo.*` commands in your Python environment — see [Local Installation](../getting-started/local-installation.md).
</Note>
