...
Containers have all dependencies pre-installed. Pick your backend and version — the default (stable release, container) gives a `docker run` that drops you straight into a ready-to-use container:
