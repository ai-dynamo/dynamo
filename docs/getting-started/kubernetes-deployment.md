...
| Put Dynamo behind Kubernetes Gateway API routing | [Gateway API Inference Extension (GAIE)](../kubernetes/gateway-api/README.mdx) |
| Use Kubernetes workload orchestration primitives | [LeaderWorkerSet (LWS)](../kubernetes/lws.md) |
