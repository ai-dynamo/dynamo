...
Package v1alpha1 contains the operator configuration API types.
...
| `signalHostPath` _string_ | SignalHostPath is the host path for signal files | /var/lib/chrek/signals |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enabled` _boolean_ | Enabled enables leader election for controller manager |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `enableHTTP2` _boolean_ | EnableHTTP2 enables HTTP/2 for metrics and webhook servers |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `metrics` _[MetricsServer](#metricsserver)_ | Metrics server configuration | \{ port:8080 \} |  |
| `healthProbe` _[Server](#server)_ | Health probe server configuration | \{ port:8081 \} |  |
