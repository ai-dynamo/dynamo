...
- `--kv-transfer-config`: Specify the KV transfer configuration JSON for vLLM (e.g., `'{"kv_connector":"NixlConnector","kv_role":"kv_both"}'`). See vLLM documentation for details. Note: `--connector` is deprecated for the vLLM backend.
