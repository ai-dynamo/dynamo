...
| `--kv-transfer-config` | KV transfer config JSON. Use LMCacheConnectorV1 to enable LMCache metrics. | (none) | `--kv-transfer-config '{"kv_connector":"LMCacheConnectorV1","kv_role":"kv_both"}'` |
