...
The Dynamo platform Helm chart includes a pre-built values file for Spot VM deployments — `dynamo/examples/deployments/AKS/values-aks-spot.yaml` — which adds the required toleration to all Dynamo components:
