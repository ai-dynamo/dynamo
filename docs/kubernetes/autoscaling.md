...
| `sglang:cache_hit_rate` | Gauge | SGLang KV cache hit rate (0-1) | ✅ Decode |
...
| Decode | KV cache utilization, ITL | `sglang:cache_hit_rate`, `dynamo_frontend_inter_token_latency_seconds` |
