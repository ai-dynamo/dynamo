...
| `DYN_ROUTER_SESSION_AFFINITY_REPLICA_SYNC` | `false` | Publishes and subscribes session-affinity bindings across router replicas. Requires `DYN_ROUTER_SESSION_AFFINITY_TTL_SECS`. |
