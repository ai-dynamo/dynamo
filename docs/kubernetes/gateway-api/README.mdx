...
See the complete EPP examples in the
[Qwen 0.6B aggregated recipe manifest](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-0.6b/vllm/agg/gaie/deploy.yaml)
and the
[Qwen 0.6B disaggregated example manifest](https://github.com/ai-dynamo/dynamo/blob/main/examples/backends/vllm/deploy/gaie/disagg.yaml).
