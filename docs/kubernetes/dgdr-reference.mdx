...
<Indent>
  <ParamField path="workload.isl" type="integer" default="4000">
    Input Sequence Length — expected average input tokens.
  </ParamField>
  <ParamField path="workload.osl" type="integer" default="1000">
    Output Sequence Length — expected average output tokens.
  </ParamField>
  <ParamField path="workload.concurrency" type="number">
    Target concurrency level. Required (or `requestRate`) when the planner is disabled.
  </ParamField>
  <ParamField path="workload.requestRate" type="number">
...
<Indent>
  <ParamField path="hardware.gpuSku" type="GPUSKUType">
  ...
  <ParamField path="hardware.vramMb" type="number">
    VRAM per GPU in MiB. Auto-detected from cluster GPU nodes when omitted.
  </ParamField>
  <ParamField path="hardware.totalGpus" type="integer">
  ...
  <ParamField path="hardware.numGpusPerNode" type="integer">
    GPUs per node. Auto-detected when omitted.
  </ParamField>
  <ParamField path="hardware.interconnect" type="string">
  ...
  <ParamField path="hardware.rdma" type="boolean">
...
<ParamField path="modelCache" type="object">
...
<Indent>
  <ParamField path="features.planner" type="object">
  ...
  <ParamField path="features.mocker" type="object">
    Configures the simulated (mocker) backend for testing without GPUs. Set `features.mocker.enabled: true` to deploy mocker workers instead of real inference workers.
  </ParamField>
</Indent>
...
<Indent>
  <ParamField path="overrides.profilingJob" type="batch/v1.JobSpec">
  ...
  <ParamField path="overrides.dgd" type="object">
    A full or partial `nvidia.com/v1alpha1` DGD used as the base for the generated deployment. Fields from profiling results are merged on top. See [Generated DGD overrides](#generated-dgd-overrides).
  </ParamField>
</Indent>
