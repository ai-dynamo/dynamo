...
<ParamField path="backend" type="'auto' | 'vllm' | 'sglang' | 'trtllm'" default="auto">
  Inference backend used for profiling and deployment.
</ParamField>

<ParamField path="searchStrategy" type="'rapid' | 'thorough'" default="rapid">
...
<Indent>
  ...
  <ParamField path="sla.optimizationType" type="'latency' | 'throughput'">
