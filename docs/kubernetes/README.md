...
- Auto-generated by the operator from the DGD's metadata (Kubernetes namespace + DGD name)
- Example: `my-llm`, `production-model`, `dynamo-dev`

> **Deprecated.** `.spec.services.<ServiceName>.dynamoNamespace` is auto-generated by the operator from the DGD's metadata and is no longer required. Remove it from new manifests; it will be ignored if present.
...
spec:
  services:
    Frontend:
      # dynamoNamespace: my-llm   # deprecated — auto-generated by operator
    ...
    VllmDecodeWorker:  # or SGLangDecodeWorker, TrtllmDecodeWorker
      # dynamoNamespace: dynamo-dev   # deprecated — auto-generated by operator
