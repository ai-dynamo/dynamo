...
**Status:** Approved — See DEP-0014 (health-endpoint-disagg-readiness) and tracking issue [#7787](https://github.com/ai-dynamo/dynamo/issues/7787). PR 1, PR 2a–d landed; PR 3 in progress.
