...
- **File names** are kebab-case (`router-configuration.md`); Chinese translations live under
  `docs/translations/zh-CN/` at the same relative path and file name as the English page (Fern's
  native localization pairs them and adds the language picker automatically).
