...
| `--dyn-chat-processor` | `DYN_CHAT_PROCESSOR` | `dynamo` | Chat processor: `dynamo` (default), `vllm`, or `sglang`. See the [Tool Calling & Reasoning Introduction](../../tool-calling/introduction.mdx) for how this combines with the parser flags. |
