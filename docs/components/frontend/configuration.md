...
| `--dyn-chat-processor` | `DYN_CHAT_PROCESSOR` | `dynamo` | Chat processor: `dynamo` (default), `vllm`, or `sglang`. See [Chat Processors](../../tool-calling/chat-processors.mdx) for how this combines with the parser flags. |
