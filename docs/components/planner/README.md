...
For throughput-based scaling, pre-deployment profiling is also required ([Profiling Guide](/docs/components/profiler/profiler_guide.md)).
...
See [Planner Guide](planner_guide.md) for the full workflow.
...
The planner will auto-discover the frontend metrics endpoint from the DGD.
