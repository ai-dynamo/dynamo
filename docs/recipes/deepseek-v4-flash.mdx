...
<span><b>Checkpoint</b> nvidia/DeepSeek-V4-Flash-NVFP4</span>
<span><b>GPUs</b> 24x B200 — 4P2D (4 prefill + 2 decode, TP4 each)</span>
<span><b>MoE / KV</b> FLASHINFER_TRTLLM, FP8 KV (block 256)</span>
...
- **4x B200** (aggregated) or **24x B200** (disaggregated, 4P2D) available.
...
- The `nvcr.io/nvstaging/ai-dynamo/vllm-runtime:1.3.0-rc.4-cuda13` image (pinned in each `deploy.yaml`).
...
| disagg-b200 (4P2D) | 24x B200 | TP4 / TP4 | FLASHINFER_TRTLLM | none | NIXL GDR |
