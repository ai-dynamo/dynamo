...
- A separate single-GPU KVBM host-memory-offload deployment guide exists at [recipes/qwen3-32b/vllm/agg-kvbm](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3-32b/vllm/agg-kvbm/README.md). It is a KVBM feature walkthrough rather than a validated recipe target (no checked-in benchmark), so it is not part of this recipe.
