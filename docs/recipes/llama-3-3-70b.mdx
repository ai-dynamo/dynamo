...
<span><b>Technique</b> Aggregated serving</span>
<span><b>Traffic</b> 8K ISL / 1K OSL, 64 concurrency</span>
</div>
...
<span><b>Technique</b> Disaggregated P/D over NIXL</span>
<span><b>Traffic</b> 8K ISL / 1K OSL, 128 concurrency</span>
</div>
...
<span><b>Technique</b> Disaggregated P/D over NIXL</span>
<span><b>Traffic</b> 8K ISL / 1K OSL, 256 concurrency</span>
</div>
</div>
...
All three targets serve `RedHatAI/Llama-3.3-70B-Instruct-FP8-dynamic` on the vLLM runtime (`nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.2.0`) and are benchmarked at 16 concurrency per GPU with 8K ISL / 1K OSL traffic:
