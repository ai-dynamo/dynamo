...
<span><b>Trace</b> 10K-request Mooncake-based coding trace, fixed schedule</span>
<span><b>Goodput SLA</b> TTFT 20s / ITL 50ms</span>
</div>
</div>
...
- The `nvcr.io/nvidia/ai-dynamo/tensorrtllm-runtime:1.2.0` image (already pinned in `deploy.yaml`).
