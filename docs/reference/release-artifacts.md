...
| `dynamo-async-openai@1.0.2` | Async OpenAI-compatible API client | `v1.82` | [link](https://crates.io/crates/dynamo-async-openai/1.0.2) |
...
uv pip install "ai-dynamo[sglang]==1.0.2"
...
- **v1.0.2**: Patch release. Bug fixes only; no backend or feature changes from v1.0.1.
...
|---------|--------------|--------|------|
| `v1.0.2` | Apr 2026 | [Release](https://github.com/ai-dynamo/dynamo/releases/tag/v1.0.2) | [Docs](https://docs.dynamo.nvidia.com/dynamo) |
...
| Crate | MSRV (Rust) | Notes |
|-------|-------------|-------|
| `dynamo-async-openai@1.0.2` | `v1.82` | |
