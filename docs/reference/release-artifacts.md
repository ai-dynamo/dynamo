...
| `fastvideo-runtime:1.0.1-cuda13` | Runtime container for FastVideo backend | FastVideo `833a33b` | `v13.1` | AMD64/ARM64 | [NGC: fastvideo-runtime 1.0.1-cuda13](https://catalog.ngc.nvidia.com/orgs/nvidia/teams/ai-dynamo/containers/fastvideo-runtime?version=1.0.1-cuda13) | |
