...
| [**KV-Aware Routing**](docs/pages/router/kv-cache-routing.md) | ✅ | ✅ | ✅ |
| [**SLA-Based Planner**](docs/pages/planner/sla-planner.md) | ✅ | ✅ | ✅ |
| [**KVBM**](docs/pages/kvbm/kvbm-architecture.md) | 🚧 | ✅ | ✅ |
| [**Multimodal**](docs/pages/multimodal/index.md) | ✅ | ✅ | ✅ |
...
- **[SLA-Driven Deployments](docs/pages/planner/sla-planner-quickstart.md)** – Optimize deployments to meet SLA requirements
...
[kv-routing]: docs/pages/router/kv-cache-routing.md
[planner]: docs/pages/planner/sla-planner.md
[kvbm]: docs/pages/kvbm/kvbm-architecture.md
