...
本指南使用 `--discovery-backend file`。如需设置 etcd，请参阅[服务发现](/dynamo/dev/knowledge-base/concepts/architecture#discovery-plane)。
...
请参阅 [Kubernetes 模型存储](/dynamo/dev/kubernetes/installation/model-storage/overview)
    了解正确配置。
