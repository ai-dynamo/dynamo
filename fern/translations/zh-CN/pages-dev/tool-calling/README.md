...
你可以启用 **xgrammar 结构化标签**，让引导式解码在 token 粒度上匹配解析器的工具调用格式。参阅 [Structural tag (guided decoding for tool calls)](https://github.com/ai-dynamo/dynamo/blob/daab017b451ecde558789e71038b4f6d4dbc91f9/docs/tool-calling/structural-tag.md)。
