...
你可以启用 **xgrammar 结构化标签**，让引导式解码在 token 粒度上匹配解析器的工具调用格式。参阅 [Structural tag (guided decoding for tool calls)](https://github.com/ai-dynamo/dynamo/blob/3db23b6bc80d9b7f1c1017f685305c4ba176edeb/docs/tool-calling/structural-tag.md)。
