...
有关流程级细节，请参阅 [Architecture Flow](/dynamo/v1.4.2/knowledge-base/concepts/system-architecture/architecture-flow)。
有关请求传输选项，请参阅 [Request Plane](/dynamo/v1.4.2/knowledge-base/concepts/communication-planes/request-plane)。
...
Planner 支持基于吞吐量和基于负载的策略。请参阅 [Planner 设计](/dynamo/zh-CN/v1.4.2/knowledge-base/modular-components/planner/planner-design)。
...
请参阅 [Fault Tolerance](/dynamo/v1.4.2/kubernetes/fault-tolerance/overview)。
...
- [Architecture Flow](/dynamo/v1.4.2/knowledge-base/concepts/system-architecture/architecture-flow)
- [Router Design](/dynamo/v1.4.2/knowledge-base/modular-components/router/router-design)
- [Planner 设计](/dynamo/zh-CN/v1.4.2/knowledge-base/modular-components/planner/planner-design)
- [Discovery Plane](/dynamo/v1.4.2/knowledge-base/concepts/communication-planes/discovery-plane)
- [Event Plane](/dynamo/v1.4.2/knowledge-base/concepts/communication-planes/event-plane)
- [Request Plane](/dynamo/v1.4.2/knowledge-base/concepts/communication-planes/request-plane)
- [Fault Tolerance](/dynamo/v1.4.2/kubernetes/fault-tolerance/overview)
- [Grove](/dynamo/v1.4.2/knowledge-base/kubernetes/multinode/grove)
