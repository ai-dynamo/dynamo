...
> **开始使用：** 请参阅 [KVBM 指南](/dynamo/v1.4.1/knowledge-base/modular-components/kvbm/kvbm-guide)，了解安装和部署说明。
...
> **了解更多：** 请参阅 [KVBM 设计文档](/dynamo/v1.4.1/knowledge-base/modular-components/kvbm/kvbm-design)，了解详细架构、组件和数据流。

## 后续步骤

- **[KVBM 指南](/dynamo/v1.4.1/knowledge-base/modular-components/kvbm/kvbm-guide)** — 安装、配置和部署说明
- **[KVBM 设计](/dynamo/v1.4.1/knowledge-base/modular-components/kvbm/kvbm-design)** — 架构深入解析、组件和数据流
- **[LMCache 集成](/dynamo/v1.4.1/cli/kv-cache-offloading/overview)** — 将 LMCache 与 Dynamo vLLM 后端配合使用
- **[FlexKV 集成](/dynamo/v1.4.1/cli/kv-cache-offloading/overview)** — 使用 FlexKV 进行 KV cache 管理
- **[SGLang HiCache](/dynamo/v1.4.1/knowledge-base/modular-components/backends/sg-lang/hi-cache)** — 通过 NIXL 启用 SGLang 的分层缓存
