...
| [SGLang](../../developer-guide/knowledge-base/modular-components/backends/sglang/multimodal.md#multimodal-kv-routing) | Rust frontend (default) | <Badge intent="success" minimal>Yes</Badge> | Hash forwarding is upstream in SGLang 0.5.13+; Dynamo pins 0.5.18. Older custom installations need the upstream patch. |
