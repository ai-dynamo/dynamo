...
- [Kubernetes LoRA Deployment Example](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/backends/vllm/deploy/lora/README.md)

## Examples

| Example | Description |
|---------|-------------|
| [Local LoRA with MinIO](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/backends/vllm/launch/lora/README.md) | Local development with S3-compatible storage |
| [Kubernetes LoRA Deployment](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/examples/backends/vllm/deploy/lora/README.md) | Production deployment with DynamoModel CRD |
