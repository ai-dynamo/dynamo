...
- Source README: [recipes/qwen3-32b-fp8/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/README.md)
- TRT-LLM aggregated: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/trtllm/agg/deploy.yaml) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/trtllm/agg/perf.yaml)
- TRT-LLM disaggregated: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/trtllm/disagg/deploy.yaml) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/trtllm/disagg/perf.yaml)
- vLLM disaggregated: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/vllm/disagg/deploy.yaml) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/vllm/disagg/perf.yaml)
- Setup assets: [model-cache/model-cache.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/model-cache/model-cache.yaml) and [model-cache/model-download.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-32b-fp8/model-cache/model-download.yaml)
