...
- [vLLM GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/examples/backends/vllm/deploy/agg_gms.yaml)
- [SGLang GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/examples/backends/sglang/deploy/agg_gms.yaml)

## Related Documentation

- [Snapshot](snapshot.md)
- [API Reference](api-reference.md)
- [vLLM failover example](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/examples/backends/vllm/deploy/agg_failover.yaml)
- [vLLM GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/examples/backends/vllm/deploy/agg_gms.yaml)
- [SGLang GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/examples/backends/sglang/deploy/agg_gms.yaml)
