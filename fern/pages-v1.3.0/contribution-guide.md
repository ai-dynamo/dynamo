...
<Tip>
VSCode and Cursor users can use the [`.devcontainer`](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/.devcontainer) folder for a pre-configured development environment. See the [devcontainer README](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/.devcontainer/README.md) for details.
</Tip>
...
6. **Request Review** — Add the person who approved your issue as a reviewer. Check [CODEOWNERS](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/CODEOWNERS) for required approvers based on files modified.
...
All PRs are checked against [pre-commit hooks](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/.pre-commit-config.yaml). After [installing pre-commit](#set-up-pre-commit-hooks), run checks locally:
