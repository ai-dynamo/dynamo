...
<Warning>Keep SPDX lines inside the frontmatter. A bare `#` SPDX line in the markdown body renders as an H1.</Warning>
...
- **Outside `docs/`** (examples, recipes, source, `container/`, sibling repos): an **absolute GitHub
  URL** like `https://github.com/ai-dynamo/dynamo/blob/v1.3.0/<path>` (use `/tree/main/` for a
