...
Enabling the embedding cache on a single aggregated GB200 replica with the vLLM backend delivers **+16% throughput, -28% TTFT, and -13% request latency** (single representative run, reproduced from the [recipe README](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-vl-30b/README.md)):
...
<td><a href="https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-vl-30b/vllm/agg-embedding-cache/deploy.yaml">deploy.yaml</a></td>
<td><a href="https://github.com/ai-dynamo/dynamo/blob/v1.3.0/recipes/qwen3-vl-30b/vllm/agg-embedding-cache/perf.yaml">perf.yaml</a></td>
</tr><tr>
...
- The aggregated embedding cache uses vLLM's native `ec_both` ECConnector role, supported in vLLM 0.17+ with no patches — see [multimodal vLLM docs](https://github.com/ai-dynamo/dynamo/blob/v1.3.0/docs/features/multimodal/multimodal-vllm.md#embedding-cache).
- Replace the `storageClassName` and `image:` placeholders in the YAML files before running.
- Source: [recipes/qwen3-vl-30b](https://github.com/ai-dynamo/dynamo/tree/v1.3.0/recipes/qwen3-vl-30b)
