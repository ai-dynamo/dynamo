...
- [vLLM multimodal examples](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/vllm/launch) (image, video)
- [TRT-LLM multimodal examples](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/trtllm/launch)
- [SGLang multimodal examples](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends/sglang/launch)
