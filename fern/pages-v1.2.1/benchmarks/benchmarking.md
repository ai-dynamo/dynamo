...
feature, check [Dynamo Recipes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/recipes)
...
Prefer [Dynamo Recipes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/recipes)
...
examples in [examples/backends](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends).
...
2. **Storage**: PersistentVolumeClaim configured with appropriate permissions (see [deploy/utils README](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/deploy/utils/README.md))
...
[Dynamo Recipe](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/recipes), the
[Deployment Overview](../kubernetes/model-deployment-guide.md), or the backend
examples in [examples/backends](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/examples/backends).
...
For development and testing purposes, Dynamo provides DynoSim and the [mocker backend](https://github.com/ai-dynamo/dynamo/blob/v1.2.1/components/src/dynamo/mocker) to simulate LLM inference without requiring actual GPU resources. This is useful for:
