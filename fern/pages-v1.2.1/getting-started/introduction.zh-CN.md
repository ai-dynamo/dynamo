...
<Tip>
准备尝试这些技术？请参阅 [Dynamo recipes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/recipes)，了解组合分离式服务、路由和卸载的分步部署示例。
</Tip>
...
- [Recipes](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/recipes) -- 组合分离式服务、路由和卸载
