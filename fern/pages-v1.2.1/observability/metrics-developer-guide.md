...
The [prometheus_names.rs](https://github.com/ai-dynamo/dynamo/tree/v1.2.1/lib/runtime/src/metrics/prometheus_names.rs) module provides centralized metric name constants and sanitization functions to ensure consistency across all Dynamo components.
