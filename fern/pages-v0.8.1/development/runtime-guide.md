...
defined in [deploy/docker-compose.yml](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/deploy/docker-compose.yml).
...
See the [README.md](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/lib/bindings/python/README.md) for details
