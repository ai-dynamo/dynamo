...
A test script is provided at [`examples/backends/sglang/test_sglang_profile.py`](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/sglang/test_sglang_profile.py) that demonstrates the full profiling workflow:
