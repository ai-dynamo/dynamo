...
For details about the profiling process, performance plots, and interpolation data, see [SLA-Driven Profiling Documentation](../benchmarks/sla-driven-profiling.md#profiling-process-details).
...
Starting in Dynamo 0.8.1, for large models, you can use a pre-populated PVC containing model weights instead of downloading from HuggingFace. See [Model Cache PVC](../benchmarks/sla-driven-profiling.md#model-cache-pvc-advanced) for configuration details.
