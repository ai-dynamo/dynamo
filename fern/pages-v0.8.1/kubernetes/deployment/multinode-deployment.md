...
- **SGLang**: [examples/backends/sglang/deploy/](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/sglang/deploy/)
- **TensorRT-LLM**: [examples/backends/trtllm/deploy/](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/trtllm/deploy/)
- **vLLM**: [examples/backends/vllm/deploy/](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/vllm/deploy/)
