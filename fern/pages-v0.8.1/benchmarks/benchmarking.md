...
Set up your Kubernetes cluster with NVIDIA GPUs and install the Dynamo Cloud platform. First follow the [installation guide](../kubernetes/installation-guide.md) to install Dynamo Cloud, then use [deploy/utils/README](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/deploy/utils/README.md) to set up benchmarking resources.
...
2. **Storage** PersistentVolumeClaim configured with appropriate permissions (see [deploy/utils README](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/deploy/utils/README.md))
