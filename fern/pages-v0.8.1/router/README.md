...
- [TRT-LLM aggregated router example](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/trtllm/deploy/agg_router.yaml)
- [vLLM aggregated router example](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/vllm/deploy/agg_router.yaml)
- [SGLang aggregated router example](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/backends/sglang/deploy/agg_router.yaml)
- [Distributed inference tutorial](https://github.com/ai-dynamo/dynamo/blob/v0.8.1/examples/basics/kubernetes/Distributed_Inference/agg_router.yaml)
