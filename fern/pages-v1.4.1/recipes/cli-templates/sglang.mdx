...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg_agent.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg_embed.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg_multimodal_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/agg_vision.sh)
</Accordion>
</AccordionGroup>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/disagg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/disagg_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/disagg_same_gpu.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/multimodal_disagg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/multimodal_epd.sh)
</Accordion>
</AccordionGroup>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/diffusion_llada.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/image_diffusion.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/text-to-video-diffusion.sh)
</Accordion>
</AccordionGroup>
...
[`launch/lora` README](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/lora/README.md).
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/launch/lora/agg_lora.sh)
</Accordion>
</AccordionGroup>

## Source

Browse all [SGLang launch scripts](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/examples/backends/sglang/launch)
