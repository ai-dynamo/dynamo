...
The checked-in recipe includes benchmark results in [`recipes/nemotron-3.5-lightning/perf/README.md`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/perf/README.md). The pass criteria are `tok/s/user >= 50` and TTFT p50 under 5 seconds.
...
- Source README: [recipes/nemotron-3.5-lightning/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/README.md)
- vLLM README: [recipes/nemotron-3.5-lightning/vllm/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/vllm/README.md)
- EFA check helper: [recipes/nemotron-3.5-lightning/vllm/check-efa-userspace.sh](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/vllm/check-efa-userspace.sh)
- TensorRT-LLM README: [recipes/nemotron-3.5-lightning/trtllm/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/trtllm/README.md)
- Performance notes: [recipes/nemotron-3.5-lightning/perf/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3.5-lightning/perf/README.md)
- Model cache manifests: [model-cache](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/recipes/nemotron-3.5-lightning/model-cache)
