...
To measure multiple concurrencies, clear server state between runs — otherwise residual KV/prefix-cache hits skew results. See the [benchmark README](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/perf/README.md).
...
- Source README: [recipes/gpt-oss-120b/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/README.md)
- Benchmark README: [recipes/gpt-oss-120b/perf/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/perf/README.md)
- vLLM aggregated: [B200](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/vllm/agg-b200-agentic/deploy.yaml) and [H200](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/vllm/agg-h200-agentic/deploy.yaml) deploy.yaml
- vLLM disaggregated: [B200](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/vllm/disagg-b200-agentic/deploy.yaml) and [H200](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/vllm/disagg-h200-agentic/deploy.yaml) deploy.yaml
- vLLM benchmark manifest: [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/perf/perf.yaml)
- TRT-LLM aggregated: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/trtllm/agg/deploy.yaml) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/trtllm/agg/perf.yaml)
- TRT-LLM disaggregated: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/trtllm/disagg/deploy.yaml) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/gpt-oss-120b/trtllm/disagg/perf.yaml)
