...
- Source README: [recipes/qwen3.8-2.4t-a95b-fp8/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/README.md)
- GB300 aggregated chat (vLLM): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/vllm/agg-gb300-chat/deploy.yaml)
- GB300 aggregated agentic (vLLM): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/vllm/agg-gb300-agentic/deploy.yaml)
- GB200 aggregated chat (vLLM): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/vllm/agg-gb200-chat/deploy.yaml)
- GB200 aggregated agentic (vLLM): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/vllm/agg-gb200-agentic/deploy.yaml)
- GB300 aggregated chat (SGLang): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/sglang/agg-gb300-chat/deploy.yaml)
- GB300 disaggregated chat (SGLang): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/sglang/disagg-gb300-chat/deploy.yaml)
- GB200 aggregated chat (SGLang): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/sglang/agg-gb200-chat/deploy.yaml)
- GB200 disaggregated chat (SGLang): [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/sglang/disagg-gb200-chat/deploy.yaml)
- Setup assets: [model-cache.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/model-cache/model-cache.yaml) and [model-download.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/qwen3.8-2.4t-a95b-fp8/model-cache/model-download.yaml)
