...
- Source README: [recipes/nemotron-3-super/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/README.md)
- Benchmark workflow: [recipes/nemotron-3-super/perf/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/perf/README.md) and [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/perf/perf.yaml)
- B200 chat: [vllm/agg-b200-chat/deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/vllm/agg-b200-chat/deploy.yaml)
- B200 agentic: [vllm/agg-b200-agentic/deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/vllm/agg-b200-agentic/deploy.yaml)
- H200 chat: [vllm/agg-h200-chat/deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/vllm/agg-h200-chat/deploy.yaml)
- H200 agentic: [vllm/agg-h200-agentic/deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/recipes/nemotron-3-super/vllm/agg-h200-agentic/deploy.yaml)
- Model cache setup: [model-cache/](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/recipes/nemotron-3-super/model-cache) (`model-cache.yaml`, `model-download.yaml`, `model-download-fp8.yaml`)
