...
[`dynamo-backend-common`](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/lib/backend-common/), giving a
...
[`engine.rs`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/backend-common/src/engine.rs) for the
...
- Crate: [`lib/backend-common/`](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/lib/backend-common/)
- Example source: [`lib/backend-common/examples/mocker/`](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/lib/backend-common/examples/mocker/)
- Conformance kit: [`lib/backend-common/src/testing.rs`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/backend-common/src/testing.rs)
