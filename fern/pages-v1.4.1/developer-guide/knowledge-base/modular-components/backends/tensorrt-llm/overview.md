...
For full Kubernetes deployment instructions, see the [TensorRT-LLM Kubernetes Deployment Guide](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/examples/backends/trtllm/deploy/README.md).
...
- **[Deploying TensorRT-LLM with Dynamo on Kubernetes](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/examples/backends/trtllm/deploy/README.md)**: Kubernetes deployment guide
