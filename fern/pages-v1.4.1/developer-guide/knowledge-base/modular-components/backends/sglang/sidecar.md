...
[SGLang sidecar README](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/sidecar/sglang/README.md)
...
[Kubernetes quick start](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/sidecar/sglang/README.md#deploy-on-kubernetes-quick-start)
to build the CPU-only sidecar image and pair it with a stock upstream SGLang
image. The source tree includes
[aggregated](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/sidecar/sglang/deploy/agg.yaml)
and
[disaggregated](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/lib/sidecar/sglang/deploy/disagg.yaml)
manifests.
