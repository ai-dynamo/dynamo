...
This is distinct from the [Standalone Router](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/router/README.md), which is a full routing service. The standalone indexer provides only the indexing and query layer without routing logic.
...
- **[Standalone Router](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/router/README.md)**: Full routing service (routes requests to workers)
