...
See the [vLLM failover example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/vllm/deploy/agg_failover.yaml)
...
- [vLLM GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/vllm/deploy/agg_gms.yaml)
- [SGLang GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/deploy/agg_gms.yaml)

## Related Documentation

- [Snapshot](snapshot.md)
- [API Reference](../../../../reference/kubernetes-api/full-api-reference.mdx)
- [vLLM failover example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/vllm/deploy/agg_failover.yaml)
- [vLLM GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/vllm/deploy/agg_gms.yaml)
- [SGLang GMS example](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/sglang/deploy/agg_gms.yaml)
