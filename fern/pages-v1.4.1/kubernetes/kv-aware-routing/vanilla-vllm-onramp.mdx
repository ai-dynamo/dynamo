...
[`agg.yaml`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/deploy/inference-gateway/ext-proc/examples/onramp/agg.yaml).
...
available in the
[`agg.yaml` EPP resources](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/deploy/inference-gateway/ext-proc/examples/onramp/agg.yaml).
