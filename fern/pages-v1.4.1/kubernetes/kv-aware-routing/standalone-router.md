...
For an integrated frontend disaggregated example, see [`examples/backends/vllm/launch/disagg_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/examples/backends/vllm/launch/disagg_router.sh). For explicit multi-router composition, see the [Global Router README](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/global_router/README.md).
...
See [`components/src/dynamo/vllm/handlers.py`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/vllm/handlers.py) for a backend reference implementation.
...
- [Router Benchmarking](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/benchmarks/router/README.md)
