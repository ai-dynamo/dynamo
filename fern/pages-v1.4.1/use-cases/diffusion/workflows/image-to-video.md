...
Provide the source image alongside the prompt in the `/v1/videos` request. See the [launch script](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/examples/backends/sglang/launch/text-to-video-diffusion.sh) and [SGLang Examples](../../../recipes/cli-templates/sglang.mdx) for the full I2V request format and supported models.
