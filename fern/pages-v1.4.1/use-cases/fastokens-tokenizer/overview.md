...
<Steps>
  ...
  <Step title="Measure Your Workload">
    ...
    See the [frontend benchmarking guide](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/benchmarks/frontend/README.md) and the [scaling-test recipe](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/benchmarks/frontend/scripts/scaling-test.md) for a full walkthrough.
  </Step>
</Steps>
...
- [Frontend benchmarking](https://github.com/ai-dynamo/dynamo/tree/v1.4.1/benchmarks/frontend/README.md)
