...
For the profiling workflow and DGDR spec structure, see the [Profiler Guide](../../developer-guide/knowledge-base/modular-components/profiler/overview.md). Field names, types, and defaults on this page come from [`__main__.py`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/profiler/__main__.py) and [`profile_endpoint.py`](https://github.com/ai-dynamo/dynamo/blob/v1.4.1/components/src/dynamo/profiler/profile_endpoint.py).
