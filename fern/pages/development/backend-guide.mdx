...
- `migration_limit`: Maximum number of times a request may be [migrated to another Instance](../fault-tolerance/request-migration.mdx). Defaults to 0.
...
For more information about how request migration works, see the [Request Migration Architecture](../fault-tolerance/request-migration.mdx) documentation.
...
For detailed information about request cancellation, including async cancellation monitoring and context propagation patterns, see the [Request Cancellation Architecture](../fault-tolerance/request-cancellation.mdx) documentation.
