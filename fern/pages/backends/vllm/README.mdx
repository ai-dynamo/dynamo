...
| [**Conditional Disaggregation**](../../design-docs/disagg-serving.mdx#conditional-disaggregation) | 🚧 | WIP |
| [**KV-Aware Routing**](../../router/kv-cache-routing.mdx) | ✅ |  |
| [**SLA-Based Planner**](../../planner/sla-planner.mdx) | ✅ |  |
| [**Load Based Planner**](../../planner/load-planner.mdx) | 🚧 | WIP |
| [**KVBM**](../../kvbm/kvbm-architecture.mdx) | ✅ |  |
| [**LMCache**](LMCache-Integration.mdx) | ✅ |  |
| [**Prompt Embeddings**](prompt-embeddings.mdx) | ✅ | Requires `--enable-prompt-embeds` flag |
...
**Guide:** [Speculative Decoding Quickstart](speculative-decoding.mdx)
...
```
See the high-level notes in [KV Cache Routing](../../router/kv-cache-routing.mdx) on deterministic event IDs.
