...
For detailed information on LMCache metrics, including the complete list of available metrics and how to access them, see the **[LMCache Metrics section](prometheus.mdx#lmcache-metrics)** in the vLLM Prometheus Metrics Guide.
