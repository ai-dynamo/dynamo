...
| [**Conditional Disaggregation**](../../design-docs/disagg-serving.mdx#conditional-disaggregation) | 🚧 | WIP [PR](https://github.com/sgl-project/sglang/pull/7730) |
| [**KV-Aware Routing**](../../router/kv-cache-routing.mdx) | ✅ |  |
| [**SLA-Based Planner**](../../planner/sla-planner.mdx) | ✅ |  |
| [**Multimodal Support**](../../multimodal/sglang.mdx) | ✅ |  |
| [**KVBM**](../../kvbm/kvbm-architecture.mdx) | ❌ | Planned |
...
| `--migration-limit` | Max times a request can migrate between workers for fault tolerance. See [Request Migration Architecture](../../fault-tolerance/request-migration.mdx). | `0` (disabled) | N/A |
...
See [SGLang Disaggregation](sglang-disaggregation.mdx) to learn more about how sglang and dynamo handle disaggregated serving.
