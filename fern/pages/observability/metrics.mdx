...
**For visualization setup instructions**, see the [Prometheus and Grafana Setup Guide](prometheus-grafana.mdx).

**For creating custom metrics**, see the [Metrics Developer Guide](metrics-developer-guide.mdx).
...
For visualizing metrics with Prometheus and Grafana, start the observability stack. See [Observability Getting Started](README.mdx#getting-started-quickly) for instructions.
...
- **Engine Metrics** (Pass-through) - Backend engines expose their own metrics: [vLLM](../backends/vllm/prometheus.mdx) (`vllm:*`), [SGLang](../backends/sglang/prometheus.mdx) (`sglang:*`), [TensorRT-LLM](../backends/trtllm/prometheus.mdx) (`trtllm_*`)
...
- [Distributed Runtime Architecture](../design-docs/distributed-runtime.mdx)
- [Dynamo Architecture Overview](../design-docs/architecture.mdx)
- [Backend Guide](../development/backend-guide.mdx)
