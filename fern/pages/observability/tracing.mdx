...
Start the observability stack (Prometheus, Grafana, Tempo, exporters). See [Observability Getting Started](README.mdx#getting-started-quickly) for instructions.
...
When done, stop the observability stack. See [Observability Getting Started](README.mdx#getting-started-quickly) for Docker Compose commands.
