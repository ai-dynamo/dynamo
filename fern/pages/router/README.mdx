...
See the comprehensive [KV Router A/B Benchmarking Guide](../benchmarks/kv-router-ab-testing.mdx) for step-by-step instructions on deploying, configuring, and benchmarking the KV router in Kubernetes.
