...
Before setting up metrics collection, you'll need to have the Dynamo operator installed in your cluster. Follow our [Installation Guide](../installation-guide.mdx) for detailed instructions on deploying the Dynamo operator.
...
- Deployment configuration: See the [vLLM README](../../backends/vllm/README.mdx)
- Available metrics: See the [metrics guide](../../observability/metrics.mdx)
...
For more information about validating the deployment, see the [vLLM README](../../backends/vllm/README.mdx).
