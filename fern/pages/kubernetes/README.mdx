...
[Link to installation](../getting-started/installation.mdx)
...
**Dynamo Namespace**: The logical namespace used by Dynamo components for [service discovery](service-discovery.mdx).
...
For detailed installation instructions, see the [Prerequisites section](installation-guide.mdx#prerequisites) in the Installation Guide.
...
For more details or customization options (including multinode deployments), see **[Installation Guide for Dynamo Kubernetes Platform](installation-guide.mdx)**.
...
For SLA-based autoscaling, see [SLA Planner Quick Start Guide](../planner/sla-planner-quickstart.mdx).
...
Refer to the [API Reference and Documentation](api-reference.mdx) for more details.

## 📖 API Reference & Documentation

For detailed technical specifications of Dynamo's Kubernetes resources:

- **[API Reference](api-reference.mdx)** - Complete CRD field specifications for all Dynamo resources
- **[Create Deployment](deployment/create-deployment.mdx)** - Step-by-step deployment creation with DynamoGraphDeployment
- **[Operator Guide](dynamo-operator.mdx)** - Dynamo operator configuration and management
...
- Auto-discovers backend workers via [service discovery](service-discovery.mdx) (Kubernetes-native by default)
...
- **[Examples](../getting-started/examples.mdx)** - Complete working examples
- **[Create Custom Deployments](deployment/create-deployment.mdx)** - Build your own CRDs
- **[Managing Models with DynamoModel](deployment/dynamomodel-guide.mdx)** - Deploy LoRA adapters and manage models
- **[Operator Documentation](dynamo-operator.mdx)** - How the platform works
- **[Service Discovery](service-discovery.mdx)** - Discovery backends and configuration
- **[Helm Charts](https://github.com/ai-dynamo/dynamo/tree/main/deploy/helm/README.md)** - For advanced users
- **[GitOps Deployment with FluxCD](fluxcd.mdx)** - For advanced users
- **[Logging](observability/logging.mdx)** - For logging setup
- **[Multinode Deployment](deployment/multinode-deployment.mdx)** - For multinode deployment
- **[Grove](grove.mdx)** - For grove details and custom installation
- **[Monitoring](observability/metrics.mdx)** - For monitoring setup
- **[Model Caching with Fluid](model-caching-with-fluid.mdx)** - For model caching with Fluid
