...
- A Kubernetes cluster with [Dynamo Kubernetes Platform](./installation-guide) installed
...
First, follow to [See Install Dynamo Kubernetes Platform](./installation-guide).
