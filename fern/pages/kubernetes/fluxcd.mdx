...
This section describes how to use FluxCD for GitOps-based deployment of Dynamo inference graphs. GitOps enables you to manage your Dynamo deployments declaratively using Git as the source of truth. We'll use the [aggregated vLLM example](../backends/vllm/README.mdx) to demonstrate the workflow.

## Prerequisites

- A Kubernetes cluster with [Dynamo Kubernetes Platform](installation-guide.mdx) installed
...
First, follow to [See Install Dynamo Kubernetes Platform](installation-guide.mdx).
