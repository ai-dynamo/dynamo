...
If you are a Dynamo contributor the [dynamo run guide](../../reference/cli.mdx) for details on how to run this command.
...
📖 **[Managing Models with DynamoModel Guide](dynamomodel-guide.mdx)**
