...
📖 [DynamoModel API Reference](../api-reference.mdx#dynamomodel)
...
**📖 [Dynamo CRD API Reference](../api-reference.mdx#dynamomodel)**
...
- Check the [API Reference](../api-reference.mdx#dynamomodel) for advanced configuration
