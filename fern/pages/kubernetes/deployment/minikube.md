...
Once your local environment is set up, you can proceed with the [Dynamo Kubernetes Platform installation guide](../installation-guide) to deploy the platform to your local cluster.
