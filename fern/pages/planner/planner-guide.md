...
Deployment, configuration, and integration guide for the Dynamo SLA Planner. For a quick overview, see the [Planner Overview](planner-intro.md). For architecture internals, see [Planner Design](../design-docs/planner-design.md).
...
For comprehensive documentation of all configuration options, see the [DGDR Configuration Reference](../benchmarks/sla-driven-profiling.md#dgdr-configuration-reference).
...
For detailed comparison, supported configurations, and limitations, see [SLA-Driven Profiling Documentation](../benchmarks/sla-driven-profiling.md#profiling-methods).
...
- [Planner Overview](planner-intro.md) -- Overview and quick start
...
- [Pre-Deployment Profiling](../benchmarks/sla-driven-profiling.md)
