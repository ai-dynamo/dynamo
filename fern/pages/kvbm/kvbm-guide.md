...
To build KVBM from source, see the detailed instructions in the [KVBM bindings README](https://github.com/ai-dynamo/dynamo/tree/main/lib/bindings/kvbm#build-from-source).
...
<Tip>
If metrics are enabled, observe KV offloading and onboarding in the Grafana dashboard.
</Tip>
