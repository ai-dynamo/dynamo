...
The scripts in the `examples/<backend>/launch` folder like [agg.sh](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/launch/agg.sh) demonstrate how you can serve your models locally.
The corresponding YAML files like [agg.yaml](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/agg.yaml) show you how you could create a Kubernetes deployment for your inference graph.
...
**Example**: [`agg.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/agg.yaml)
...
**Example**: [`agg_router.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/agg_router.yaml)
...
**Example**: [`disagg_router.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/disagg_router.yaml)
...
- **Development / Testing**: Use [`agg.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/agg.yaml) as the base configuration.

- **Production with Load Balancing**: Use [`agg_router.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/agg_router.yaml) to enable scalable, load-balanced inference.

- **High Performance / Disaggregated Deployment**: Use [`disagg_router.yaml`](https://github.com/ai-dynamo/dynamo/tree/v1.0.2/examples/backends/vllm/deploy/disagg_router.yaml) for maximum throughput and modular scalability.
