...
docker run --rm -it \
  --gpus all \
  --network host \
  nvcr.io/nvidia/ai-dynamo/sglang-runtime:0.8.0  # or vllm, tensorrtllm
```

<Callout intent="info">

Replace `0.8.0` with your desired version tag. Check the [GitHub releases](https://github.com/ai-dynamo/dynamo/releases) for available versions.
