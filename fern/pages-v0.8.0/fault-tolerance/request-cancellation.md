...
For a working example of request cancellation, see the [cancellation demo](https://github.com/ai-dynamo/dynamo/blob/v0.8.0/examples/custom_backend/cancellation/README.md).
