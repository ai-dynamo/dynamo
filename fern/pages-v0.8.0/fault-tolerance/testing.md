...
Dynamo's fault tolerance test suite is located in `tests/fault-tolerance/` and includes:
...
pytest tests/fault-tolerance/cancellation/ -v

# Run for specific backend
pytest tests/fault-tolerance/cancellation/test_vllm.py -v
```
...
pytest tests/fault-tolerance/migration/ -v

# Run for specific backend
pytest tests/fault-tolerance/migration/test_vllm.py -v
```
...
```bash
pytest tests/fault-tolerance/etcd_ha/ -v
```
...
Located at `tests/fault-tolerance/hardware/fault_injection_service/`, this FastAPI service orchestrates fault injection:

```bash
# Start the fault injection service
cd tests/fault-tolerance/hardware/fault_injection_service
...
pytest tests/fault-tolerance/deploy/test_deployment.py -v

# Run specific scenario
pytest tests/fault-tolerance/deploy/test_deployment.py::test_worker_failure -v
```
...
pytest tests/fault-tolerance/ -v --tb=short

# Run with specific markers
pytest tests/fault-tolerance/ -v -m "not slow"
```
...
```bash
pytest tests/fault-tolerance/ -v \
