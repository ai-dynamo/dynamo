...
<Tip>
**New to SLA Planner?** For a complete workflow including profiling and deployment, see the [SLA Profiling + Planner Quick Start Guide](../planner/sla-planner-quickstart.md).
</Tip>
...
The adjustment interval can be defined in the planner manifest as an argument. The default interval value can be found in this [file](https://github.com/ai-dynamo/dynamo/blob/v0.8.0/components/src/dynamo/planner/defaults.py).
...
For complete deployment instructions, see the [SLA Planner Quick Start Guide](../planner/sla-planner-quickstart.md).
