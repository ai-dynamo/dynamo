...
See [`launch/dsr1_dep.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/examples/backends/vllm/launch/dsr1_dep.sh) for configurable options.

## Kubernetes Deployment

For complete Kubernetes deployment instructions, configurations, and troubleshooting, see the [vLLM Kubernetes Deployment Guide](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/examples/backends/vllm/deploy/README.md).
