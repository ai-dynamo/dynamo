...
| -------------------------- | --------------------------------------------------------------------------------------- |
| Aggregated                 | [`agg_kvbm.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_kvbm.sh)                     |
| Aggregated + KV routing    | [`agg_kvbm_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_kvbm_router.sh)       |
| Disaggregated (1P1D)       | [`disagg_kvbm.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/disagg_kvbm.sh)               |
| Disaggregated (2P2D)       | [`disagg_kvbm_2p2d.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/disagg_kvbm_2p2d.sh)     |
| Disaggregated + KV routing | [`disagg_kvbm_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/disagg_kvbm_router.sh) |
...
| Deployment                        | Launch Script                                                                                 |
| --------------------------------- | --------------------------------------------------------------------------------------------- |
| Aggregated                        | [`agg_lmcache.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_lmcache.sh)                     |
| Aggregated (multiprocess metrics) | [`agg_lmcache_multiproc.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_lmcache_multiproc.sh) |
| Disaggregated                     | [`disagg_lmcache.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/disagg_lmcache.sh)               |
...
| Deployment              | Launch Script                                                                         |
| ----------------------- | ------------------------------------------------------------------------------------- |
| Aggregated              | [`agg_flexkv.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_flexkv.sh)               |
| Aggregated + KV routing | [`agg_flexkv_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/agg_flexkv_router.sh) |
| Disaggregated           | [`disagg_flexkv.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/backends/vllm/launch/disagg_flexkv.sh)         |
