...
More configurations please refer to https://github.com/ai-dynamo/dynamo/tree/v1.1.1/examples/deployments/GKE/vllm
...
For example, refer to the following from [`examples/deployments/GKE/vllm/disagg.yaml`](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/examples/deployments/GKE/vllm/disagg.yaml)
