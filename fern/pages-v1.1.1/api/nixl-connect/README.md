...
See [NixlReadEmbeddingSender](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/components/src/dynamo/common/multimodal/embedding_transfer.py),
...
See [NixlReadEmbeddingReceiver](https://github.com/ai-dynamo/dynamo/blob/v1.1.1/components/src/dynamo/common/multimodal/embedding_transfer.py),
...
## References
  ...
  - [Dynamo Multimodal Example](https://github.com/ai-dynamo/dynamo/tree/v1.1.1/examples/backends/vllm/launch)
