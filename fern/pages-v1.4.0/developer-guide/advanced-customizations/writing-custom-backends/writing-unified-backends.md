...
[`dynamo.common.backend`](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/components/src/dynamo/common/backend):
...
[`sample_engine.py`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/sample_engine.py)
...
- [`LLMEngine` ABC docstrings](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/engine.py)
  — authoritative method-by-method contract.
- [Package README](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/README.md)
...
— see
[Request / Response Types](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/README.md#request--response-types)
...
[`LLMEngine` trait](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/engine.rs).
...
[`dynamo.llm.exceptions`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/README.md#error-handling)
...
[suite](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/tests/test_engine.py)
...
- [`LLMEngine` ABC](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/engine.py)
  — authoritative contract.
- [Package README](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/README.md)
  — lifecycle, error model, and request/response contract.
- [Sample engine](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/sample_engine.py)
  — example user guide.
...
This guide covers the unified backend infrastructure in
[`dynamo-backend-common`](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/lib/backend-common):
...
[`LLMEngine`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/engine.rs) contract in
[`dynamo-backend-common`](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/lib/backend-common) — no Python
...
[`lib/backend-common/examples/mocker`](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/lib/backend-common/examples/mocker)
...
- This guide — step-by-step walkthrough for someone starting a new
  backend from scratch.
- [`LLMEngine` trait doc comments](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/engine.rs)
  — authoritative method-by-method contract.
- [Crate README](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/README.md) — in-tree
  reference: architecture, file index, disaggregation contract,
  error taxonomy, conformance kit.
- [`backend-common` design notes](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/CLAUDE.md)
...
**Contract** (the [debug-mode validator](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/validate.rs)
...
2. During cleanup the stream sees both `ctx.stopped()` and
   ...
   mocker's [stream body](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/examples/mocker/src/engine.rs)
   spells this out.
...
[`docker-compose.yml`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/examples/mocker/docker-compose.yml)
and [`Dockerfile.frontend`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/examples/mocker/Dockerfile.frontend)**,
...
- [`LLMEngine` trait](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/engine.rs) — authoritative contract.
- [Design notes](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/CLAUDE.md) — rationale and
  invariants.
- [`Worker`](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/worker.rs) — runtime
  lifecycle internals (signal handling, graceful shutdown, model
  registration).
- [Conformance kit](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/backend-common/src/testing.rs) —
...
- [Python sibling](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/components/src/dynamo/common/backend/README.md)
