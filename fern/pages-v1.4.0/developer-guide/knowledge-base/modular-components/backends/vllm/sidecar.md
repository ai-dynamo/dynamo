...
[vLLM sidecar README](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/sidecar/vllm/README.md)
...
[Kubernetes quick start](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/sidecar/vllm/README.md#deploy-on-kubernetes-quick-start)
to build the CPU-only sidecar image and pair it with a stock upstream vLLM
image. The source tree includes
[aggregated](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/sidecar/vllm/deploy/agg.yaml)
and
[disaggregated](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/lib/sidecar/vllm/deploy/disagg.yaml)
manifests.
