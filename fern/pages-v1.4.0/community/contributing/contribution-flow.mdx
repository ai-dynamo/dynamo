...
<Steps toc={true}>
  ...
  <Step title="Complete automated review and CI">
    ...
    For external contributions, a maintainer might need to authorize CI for the latest commit. If
    requested, wait for a maintainer to trigger the tests rather than repeatedly pushing unchanged
    commits.
  ...
  <Step title="Request and address review">
    ...
    [CODEOWNERS](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/CODEOWNERS) file identifies required
