...
| Skill | Description |
|-------|-------------|
| [dynamo-docs](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/.agents/skills/dynamo-docs/SKILL.md) | Add, update, move, or remove a docs page |
...
5. Rewrites GitHub links in the snapshot:
   - `github.com/ai-dynamo/dynamo/tree/v1.4.0` → `tree/vX.Y.Z`
   - `github.com/ai-dynamo/dynamo/blob/v1.4.0` → `blob/vX.Y.Z`
