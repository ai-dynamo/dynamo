...
| Goal | Start Here |
| --- | --- |
| Make your first code change | [Getting Started](getting-started.mdx) |
| Understand when to open an issue and how to submit a pull request | [Contribution Flow](contribution-flow.mdx) |
| Prepare code, tests, and commit messages | [Code Quality](code-quality.md) |
| Sign commits or fix a DCO check | [DCO and Licensing](dco-and-licensing.md) |
| Improve the documentation | [Documentation Style Guide](documentation/documentation-style-guide.md) |
| Build or preview the documentation site | [Building and Publishing](documentation/building-and-publishing.md) |
...
- [Getting Started](getting-started.mdx) is a tutorial for setting up a fork, preparing
  a development environment, and creating a signed first commit.
- [Contribution Flow](contribution-flow.mdx) explains issue-first changes, pull request
  submission, continuous integration (CI), and review.
- [Code Quality](code-quality.md) collects code style, testing, pre-commit, and commit
  message conventions.
- [DCO and Licensing](dco-and-licensing.md) explains sign-off requirements and how to
...
[Code of Conduct](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/CODE_OF_CONDUCT.md). By contributing,
you agree that your contribution is licensed under the
[Apache 2.0 License](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/LICENSE).
