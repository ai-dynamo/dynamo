...
The checked-in
[aggregated Mocker example](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/mocker/deploy/agg.yaml)
...
[disaggregated Mocker example](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/mocker/deploy/disagg.yaml).
