...
In the `cache.yaml` in the different [recipes](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/recipes), you can set the `storageClassName` to a storage option available in your AKS cluster:
