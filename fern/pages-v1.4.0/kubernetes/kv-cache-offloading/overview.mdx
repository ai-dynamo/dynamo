...
This aggregated Qwen3-32B worker offloads KV blocks to 100 GB of host memory. It is the worker section of the [agg-kvbm recipe](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/recipes/qwen3-32b/vllm/agg-kvbm/deploy.yaml):
