...
<BlogArticleMeta
  authors={[{ name: "NVIDIA Dynamo team" }]}
  category="Ecosystem"
  date="May 6, 2026"
  readTime="1 min read"
/>
...
See the [Kimi K2.5 TokenSpeed recipe](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/recipes/kimi-k2.5/tokenspeed/agg/nvidia) for the current Dynamo launch recipe.
