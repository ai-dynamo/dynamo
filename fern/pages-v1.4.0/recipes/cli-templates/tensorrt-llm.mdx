...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_metrics.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_multimodal.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_multimodal_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_router_approx.sh)
</Accordion>
</AccordionGroup>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/disagg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/disagg_router.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/disagg_same_gpu.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/gpt_oss_disagg.sh)
</Accordion>
</AccordionGroup>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_image_diffusion.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/agg_video_diffusion.sh)
</Accordion>
</AccordionGroup>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/disagg_e_pd.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/disagg_multimodal.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/epd_disagg.sh)
</Accordion>
...
[View the launch script.](https://github.com/ai-dynamo/dynamo/blob/v1.4.0/examples/backends/trtllm/launch/epd_multimodal_image_and_embeddings.sh)
</Accordion>
</AccordionGroup>

## Source

Browse all [TensorRT-LLM launch scripts](https://github.com/ai-dynamo/dynamo/tree/v1.4.0/examples/backends/trtllm/launch)
