...
- workers: [VideoEncodeWorker](https://github.com/ai-dynamo/dynamo/releases/tag/v0.9.1) for decoding video into frames, and [VllmPDWorker](https://github.com/ai-dynamo/dynamo/releases/tag/v0.9.1) for prefilling and decoding.
...
- workers: [AudioEncodeWorker](https://github.com/ai-dynamo/dynamo/blob/59d32d259df3669bd7f120175452591482dca5eb/examples/multimodal/components/audio_encode_worker.py) for decoding audio into embeddings, and [VllmPDWorker](https://github.com/ai-dynamo/dynamo/releases/tag/v0.9.1) for prefilling and decoding.
