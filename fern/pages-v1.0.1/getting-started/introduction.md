...
<Tip>
Ready to try these techniques? See [Dynamo recipes](https://github.com/ai-dynamo/dynamo/tree/v1.0.1/recipes) for step-by-step deployment examples that compose disaggregated serving, routing, and offloading.
</Tip>
...
- [Recipes](https://github.com/ai-dynamo/dynamo/tree/v1.0.1/recipes) -- Compose disaggregated serving, routing, and offloading
