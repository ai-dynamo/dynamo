...
The planner will auto-discover the frontend metrics endpoint from the DGD. See [disagg_planner_load.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.0.1/tests/planner/scaling/disagg_planner_load.yaml) for a complete example.
