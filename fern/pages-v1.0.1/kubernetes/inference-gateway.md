...
This file demonstrates the values needed for the vLLM aggregated setup in [agg.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.0.1/examples/backends/vllm/deploy/agg.yaml)
...
**Configuration**
You can configure the plugin by setting environment variables in the EPP component of your DGD in case of the operator-managed installation or in your [values.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.0.1/deploy/inference-gateway/standalone/helm/dynamo-gaie/values.yaml).
