...
| Skill | Description |
|-------|-------------|
| [dynamo-docs](https://github.com/ai-dynamo/dynamo/blob/v1.0.1/.claude/skills/dynamo-docs/SKILL.md) | Add, update, move, or remove a docs page |
...
4. Rewrites GitHub links in the snapshot:
   - `github.com/ai-dynamo/dynamo/tree/v1.0.1` → `tree/vX.Y.Z`
   - `github.com/ai-dynamo/dynamo/blob/v1.0.1` → `blob/vX.Y.Z`
