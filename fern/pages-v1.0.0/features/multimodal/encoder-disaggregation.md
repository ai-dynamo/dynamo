...
See the backend-specific documentation ([vLLM](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/docs/features/multimodal/multimodal-vllm.md), [TRT-LLM](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/docs/features/multimodal/multimodal-trtllm.md), [SGLang](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/docs/features/multimodal/multimodal-sglang.md)) for full configuration details and component flags.
