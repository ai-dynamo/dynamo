...
The local Docker workflow builds a runtime image from the [`Dockerfile`](https://github.com/ai-dynamo/dynamo/tree/v1.0.0/examples/diffusers/Dockerfile):
...
The example source lives at [`examples/diffusers/`](https://github.com/ai-dynamo/dynamo/tree/v1.0.0/examples/diffusers) in the Dynamo repository.
