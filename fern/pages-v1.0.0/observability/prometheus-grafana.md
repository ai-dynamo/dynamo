...
The Prometheus configuration is specified in [prometheus.yml](https://github.com/ai-dynamo/dynamo/tree/v1.0.0/deploy/observability/prometheus.yml). This file is set up to collect metrics from the metrics aggregation service endpoint.
