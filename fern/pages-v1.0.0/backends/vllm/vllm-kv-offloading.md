...
| -------------------------- | --------------------------------------------------------------------------------------- |
| Aggregated                 | [`agg_kvbm.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/agg_kvbm.sh)                     |
| Aggregated + KV routing    | [`agg_kvbm_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/agg_kvbm_router.sh)       |
| Disaggregated (1P1D)       | [`disagg_kvbm.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/disagg_kvbm.sh)               |
| Disaggregated (2P2D)       | [`disagg_kvbm_2p2d.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/disagg_kvbm_2p2d.sh)     |
| Disaggregated + KV routing | [`disagg_kvbm_router.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/disagg_kvbm_router.sh) |
...
| Deployment                        | Launch Script                                                                                 |
| --------------------------------- | --------------------------------------------------------------------------------------------- |
| Aggregated                        | [`agg_lmcache.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/agg_lmcache.sh)                     |
| Aggregated (multiprocess metrics) | [`agg_lmcache_multiproc.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/agg_lmcache_multiproc.sh) |
| Disaggregated                     | [`disagg_lmcache.sh`](https://github.com/ai-dynamo/dynamo/blob/v1.0.0/examples/backends/vllm/launch/disagg_lmcache.sh)               |
