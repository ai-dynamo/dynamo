...
defined in [deploy/docker-compose.yml](https://github.com/ai-dynamo/dynamo/tree/v1.0.0/deploy/docker-compose.yml).
...
See the [README.md](https://github.com/ai-dynamo/dynamo/tree/v1.0.0/lib/runtime/lib/bindings/python/README.md) for details
