        ...
        **Prerequisites**
        ...
        <AccordionGroup>
          <Accordion title="Build and deploy FastVideo">
            Build the purpose-built runtime from [`examples/diffusers/Dockerfile`](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/examples/diffusers/Dockerfile). The first build can take 20–40 minutes or longer because it installs FastVideo and compiles its dependencies.
