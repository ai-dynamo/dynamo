...
The runtime image is built from the [`Dockerfile`](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/examples/diffusers/Dockerfile):
...
The example source lives at [`examples/diffusers/`](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/examples/diffusers) in the Dynamo repository.
