...
- **[Deploying TensorRT-LLM with Dynamo on Kubernetes](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/examples/backends/trtllm/deploy/README.md)**: Kubernetes deployment guide
