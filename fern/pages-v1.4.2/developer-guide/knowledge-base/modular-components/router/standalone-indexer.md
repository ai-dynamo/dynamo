...
- **[Standalone Router](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/components/src/dynamo/router/README.md)**: Full routing service (routes requests to workers)
