...
See the [Kimi K2.5 TokenSpeed recipe](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/recipes/kimi-k2.5/tokenspeed/agg/nvidia) for the current Dynamo launch recipe.
