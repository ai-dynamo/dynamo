...
For trace staging, concurrency sweeps, and fetching artifacts, see the [benchmark README](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/perf/README.md).
...
- Source README: [recipes/glm-5.2/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/README.md)
- Benchmark README: [recipes/glm-5.2/perf/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/perf/README.md)
- Aggregated B200: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/sglang/agg-b200-agentic/deploy.yaml)
- Disaggregated B200: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/sglang/disagg-b200-agentic/deploy.yaml)
- Aggregated H200: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/sglang/agg-h200-agentic/deploy.yaml)
- Disaggregated H200: [deploy.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/sglang/disagg-h200-agentic/deploy.yaml)
- Setup assets: [model-cache.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/model-cache/model-cache.yaml) and [model-download.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/model-cache/model-download.yaml)
- Benchmark manifest: [perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/glm-5.2/perf/perf.yaml)
