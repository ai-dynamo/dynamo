...
<Warning>
Edit cluster-specific values before applying: `storageClassName` in `model-cache/model-cache.yaml` (a RWX class). For **disaggregated** targets, also set `VLLM_GPU_NIC_PCIE_MAPPING` in the manifest — see [Per-rank NIC mapping](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/deepseek-v4/README.md#per-rank-nic-mapping-b200--h200-disaggregated).
</Warning>
...
The shared [`perf.yaml`](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/deepseek-v4/perf/perf.yaml) replays the agentic MoonTrace (64K avg ISL / 400 OSL, 90% KV reuse) with AIPerf. Point `ENDPOINT` at `${DGD}-frontend:8000` and apply it:
...
- **Disaggregated** targets require the per-rank NIC map (`VLLM_GPU_NIC_PCIE_MAPPING`); B200 ships `rdma/shared_ib`, H200 ships `rdma/ib`. See the [top-level README](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/deepseek-v4/README.md#per-rank-nic-mapping-b200--h200-disaggregated).
...
- Recipe README: [recipes/deepseek-v4/deepseek-v4-pro/README.md](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/deepseek-v4/deepseek-v4-pro/README.md)
...
- Manifests: [vllm/](https://github.com/ai-dynamo/dynamo/tree/v1.4.2/recipes/deepseek-v4/deepseek-v4-pro/vllm) and shared [perf/perf.yaml](https://github.com/ai-dynamo/dynamo/blob/v1.4.2/recipes/deepseek-v4/perf/perf.yaml)
