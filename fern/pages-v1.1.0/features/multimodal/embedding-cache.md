...
> Note: This feature can also be referred to as **encoder cache**. Embedding cache is separate from KV cache, which reuses attention key/value state after prefill to skip prefill and go straight to decode. For KV cache reuse and routing, see [Multimodal KV Routing](https://github.com/ai-dynamo/dynamo/blob/v1.1.0/docs/features/multimodal/multimodal-kv-routing.md).
## When to Use
...
See the backend-specific documentation ([vLLM](https://github.com/ai-dynamo/dynamo/blob/v1.1.0/docs/features/multimodal/multimodal-vllm.md#embedding-cache), [TRT-LLM](https://github.com/ai-dynamo/dynamo/blob/v1.1.0/docs/features/multimodal/multimodal-trtllm.md#embedding-cache)) for more details.
