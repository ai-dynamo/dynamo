...
Follow the [Dynamo Kubernetes Installation Guide](https://github.com/ai-dynamo/dynamo/blob/v1.1.0/docs/kubernetes/installation-guide.md) to install the platform in `dynamo-bench`.
