 ...
 *
 * Dynamo site chrome styles (header, sidebar, footer, landing page, cards).
 *
 ...
 * at publish. Loaded site-wide from CustomFooter.tsx (registered in docs.yml).
 *
 * Server component (no "use client"); same pattern as RecipeStyles.tsx.
 */
