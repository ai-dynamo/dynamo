...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticEPRayPoCConfiguration) DeepCopyInto(out *ElasticEPRayPoCConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticEPRayPoCConfiguration.
func (in *ElasticEPRayPoCConfiguration) DeepCopy() *ElasticEPRayPoCConfiguration {
	if in == nil {
		return nil
	}
	out := new(ElasticEPRayPoCConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OperatorConfiguration) DeepCopyInto(out *OperatorConfiguration) {
	*out = *in
	...
	out.ElasticEPRayPoC = in.ElasticEPRayPoC
