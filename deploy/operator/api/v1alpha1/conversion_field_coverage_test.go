...
DynamoComponentDeploymentSpec.device.nodeSelector
DynamoComponentDeploymentSpec.device.resources
DynamoComponentDeploymentSpec.device.schedulerName
DynamoComponentDeploymentSpec.device.tolerations
...
DynamoGraphDeploymentSpec.components.device.nodeSelector
DynamoGraphDeploymentSpec.components.device.resources
DynamoGraphDeploymentSpec.components.device.schedulerName
DynamoGraphDeploymentSpec.components.device.tolerations
