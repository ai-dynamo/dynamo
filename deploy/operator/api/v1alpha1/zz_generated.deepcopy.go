...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LPXComponentStatus) DeepCopyInto(out *LPXComponentStatus) {
	*out = *in
	in.ComponentReplicaStatus.DeepCopyInto(&out.ComponentReplicaStatus)
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LPXComponentStatus.
func (in *LPXComponentStatus) DeepCopy() *LPXComponentStatus {
	if in == nil {
		return nil
	}
	out := new(LPXComponentStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LPXGraphDeploymentStatus) DeepCopyInto(out *LPXGraphDeploymentStatus) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make(map[string]LPXComponentStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
