...
func (in *EPPConfig) DeepCopyInto(out *EPPConfig) {
	*out = *in
	...
	if in.PoolNamespace != nil {
		in, out := &in.PoolNamespace, &out.PoolNamespace
		*out = new(string)
		**out = **in
	}
	if in.KVBlockSize != nil {
		in, out := &in.KVBlockSize, &out.KVBlockSize
		*out = new(string)
		**out = **in
	}
	if in.UseEtcd != nil {
		in, out := &in.UseEtcd, &out.UseEtcd
		*out = new(bool)
		**out = **in
	}
}
