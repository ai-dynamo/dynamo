...
type DynamoComponentDeploymentSharedSpec struct {
	...
	// Keep this value aligned with the intended runtime compatibility version. Changing it may alter
	// runtime-gated Pod rendering and trigger a rollout, even when the image does not change.
