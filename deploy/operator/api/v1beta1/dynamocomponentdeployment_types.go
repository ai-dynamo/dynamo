...
type DynamoComponentDeploymentSharedSpec struct {
	...
	// example "1.4.0". It does not change the image. The operator may use it for version-gated defaults,
	// so changing it can change the rendered Pod and trigger a rollout.
