...
// DynamoGraphPowerBudgetPendingReason is a bounded replica-request failure reason.
...
type DynamoGraphPowerBudgetPendingReason string

const (
	// DynamoGraphPowerBudgetPendingReasonBudgetExceeded indicates that the complete
	// requested vector would exceed the immutable budget.
	DynamoGraphPowerBudgetPendingReasonBudgetExceeded DynamoGraphPowerBudgetPendingReason = "BudgetExceeded"
	// DynamoGraphPowerBudgetPendingReasonUnenforcedBaseline indicates that existing
	// capacity lacks the evidence required to admit an increase.
	DynamoGraphPowerBudgetPendingReasonUnenforcedBaseline DynamoGraphPowerBudgetPendingReason = "UnenforcedBaseline"
	// DynamoGraphPowerBudgetPendingReasonUnsupportedTopology indicates that the DGD
	// topology cannot be accounted for transactionally.
	DynamoGraphPowerBudgetPendingReasonUnsupportedTopology DynamoGraphPowerBudgetPendingReason = "UnsupportedTopology"
	// DynamoGraphPowerBudgetPendingReasonUnqualifiedHardware indicates that watched
	// hardware falls outside the qualified SKU pool.
	DynamoGraphPowerBudgetPendingReasonUnqualifiedHardware DynamoGraphPowerBudgetPendingReason = "UnqualifiedHardware"
	// DynamoGraphPowerBudgetPendingReasonBelowMinimum indicates that a requested
	// component target is below the immutable endpoint floor.
	DynamoGraphPowerBudgetPendingReasonBelowMinimum DynamoGraphPowerBudgetPendingReason = "BelowMinimum"
	// DynamoGraphPowerBudgetPendingReasonInvalidTarget indicates that a requested
	// component target is otherwise invalid.
	DynamoGraphPowerBudgetPendingReasonInvalidTarget DynamoGraphPowerBudgetPendingReason = "InvalidTarget"
)
