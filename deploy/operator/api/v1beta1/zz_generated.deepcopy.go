...
func (in *DynamoGraphDeploymentRequestSpec) DeepCopyInto(out *DynamoGraphDeploymentRequestSpec) {
	*out = *in
	...
	if in.Thorough != nil {
		in, out := &in.Thorough, &out.Thorough
		*out = new(ThoroughSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.AutoApply != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ThoroughSpec) DeepCopyInto(out *ThoroughSpec) {
	*out = *in
	if in.PrefilterTopN != nil {
		in, out := &in.PrefilterTopN, &out.PrefilterTopN
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ThoroughSpec.
func (in *ThoroughSpec) DeepCopy() *ThoroughSpec {
	if in == nil {
		return nil
	}
	out := new(ThoroughSpec)
