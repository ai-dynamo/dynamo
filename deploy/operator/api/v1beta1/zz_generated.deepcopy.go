...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentGroupComponentSpec) DeepCopyInto(out *ComponentGroupComponentSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentGroupComponentSpec.
func (in *ComponentGroupComponentSpec) DeepCopy() *ComponentGroupComponentSpec {
	if in == nil {
		return nil
	}
	out := new(ComponentGroupComponentSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentGroupSpec) DeepCopyInto(out *ComponentGroupSpec) {
	*out = *in
	...
	if in.Components != nil {
		...
		*out = make([]ComponentGroupComponentSpec, len(*in))
		copy(*out, *in)
	}
}
...
func (in *DynamoGraphDeploymentExperimentalSpec) DeepCopyInto(out *DynamoGraphDeploymentExperimentalSpec) {
	*out = *in
	...
	if in.ComponentGroups != nil {
		...
		*out = make([]ComponentGroupSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
