...
func (in *AuditAwsS3Spec) DeepCopyInto(out *AuditAwsS3Spec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuditAwsS3Spec.
func (in *AuditAwsS3Spec) DeepCopy() *AuditAwsS3Spec {
	if in == nil {
		return nil
	}
	out := new(AuditAwsS3Spec)
	in.DeepCopyInto(out)
	return out
}
