...
func (v *sharedValidation) validateDynamoComponentDeploymentSharedSpecV1alpha1(
	...
	if spec.Autoscaling != nil {
		v.warnf(
			"%s.autoscaling is deprecated and ignored. Use DynamoGraphDeploymentScalingAdapter with HPA, KEDA, or Planner for autoscaling instead. See https://docs.nvidia.com/dynamo/dev/reference/kubernetes-api/full-api-reference#dynamographdeploymentscalingadapter",
			fldPath,
		)
	}
