...
var canaryHealthCheckMinimumRuntimeVersion = runtimeversion.Version{Major: 1, Minor: 4, Patch: 0}
...
func (w *WorkerDefaults) GetBaseContainer(context ComponentContext) (corev1.Container, error) {
	...
	canaryHealthChecksEnabled := context.RuntimeVersionKnown &&
		context.RuntimeVersion.AtLeast(canaryHealthCheckMinimumRuntimeVersion)
