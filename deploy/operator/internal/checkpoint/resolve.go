...
func DeletionPolicy(policy nvidiacomv1alpha1.CheckpointDeletionPolicy) nvidiacomv1alpha1.CheckpointDeletionPolicy {
	if policy == "" {
		return nvidiacomv1alpha1.CheckpointDeletionPolicyDelete
	}
	return policy
}

func UsesRetainDeletionPolicy(policy nvidiacomv1alpha1.CheckpointDeletionPolicy) bool {
	return DeletionPolicy(policy) == nvidiacomv1alpha1.CheckpointDeletionPolicyRetain
}
