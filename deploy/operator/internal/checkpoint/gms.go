...
const (
	...
	// EnvCheckpointDir is the GMS control directory where saver/loader
	// sidecars write completion sentinels for diagnostics.
...
// saver. The saver is a regular Job container so Job completion waits for the
// GMS save to finish.
