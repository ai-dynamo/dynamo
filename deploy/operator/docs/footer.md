...
- **Checkpoint / Restore**:
  ...
  - [`internal/checkpoint/native.go`](https://github.com/ai-dynamo/dynamo/blob/main/deploy/operator/internal/checkpoint/native.go) - Snapshot resource resolution and restore validation
