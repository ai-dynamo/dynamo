...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompilationCacheRef) DeepCopyInto(out *CompilationCacheRef) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompilationCacheRef.
func (in *CompilationCacheRef) DeepCopy() *CompilationCacheRef {
	if in == nil {
		return nil
	}
	out := new(CompilationCacheRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DynamoComponentDeploymentSharedSpec) DeepCopyInto(out *DynamoComponentDeploymentSharedSpec) {
	*out = *in
	...
	if in.CompilationCacheRef != nil {
		in, out := &in.CompilationCacheRef, &out.CompilationCacheRef
		*out = new(CompilationCacheRef)
		(*in).DeepCopyInto(*out)
	}
	if in.Ingress != nil {
