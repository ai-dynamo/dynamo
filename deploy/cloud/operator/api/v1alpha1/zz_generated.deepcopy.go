...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CompilationCachePVC) DeepCopyInto(out *CompilationCachePVC) {
	*out = *in
	in.PVC.DeepCopyInto(&out.PVC)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CompilationCachePVC.
func (in *CompilationCachePVC) DeepCopy() *CompilationCachePVC {
	if in == nil {
		return nil
	}
	out := new(CompilationCachePVC)
	in.DeepCopyInto(out)
	return out
}
