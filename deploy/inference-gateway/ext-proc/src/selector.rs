...
impl Selector {
    ...
    /// Build a [`CatalogReconciler`] backed by this selector's core. Used by
    /// [`crate::topology_adapter`] to keep the catalog in step with pod events,
    /// and by tests to seed the catalog directly.
