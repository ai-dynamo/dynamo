...
![Version: 1.1.0-dev.3](https://img.shields.io/badge/Version-1.1.0--dev.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://components/operator | dynamo-operator | 1.1.0-dev.3 |
