...
![Version: 1.2.0-post.1](https://img.shields.io/badge/Version-1.2.0--post.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://components/operator | dynamo-operator | 1.2.0-post.1 |
