...
| dynamo-operator.lpx.enabled | bool | `false` | Enable LPX integration. Startup requires the externally installed scheduling.lpu.nvidia.com/v1alpha1 LpuPipelineRequest and scheduler.grove.io/v1alpha1 PodGang APIs. |
