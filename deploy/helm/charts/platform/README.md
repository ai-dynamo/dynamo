...
| dynamo-operator.featureGates.DGDRV1Beta2 | bool | `false` | EXPERIMENTAL: Install the DGDR v1beta2 API schemas. This exposes the schemas for development only; the operator does not reconcile v1beta2 resources. |
