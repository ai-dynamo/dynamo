...
def add_request_id_to_response(response: Union[Response, StreamingResponse], request_id: str) -> None:
...
class RequestTracingMixin:
    ...
    def log_with_request_id(self, level: str, message: str, request_id: Optional[str] = None):
