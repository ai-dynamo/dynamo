...
```bash
cd examples/custom_backend/hello_world/basic
...
Follow the [Quickstart Guide](https://github.com/ai-dynamo/dynamo/blob/main/docs/fern/pages/kubernetes/getting-started/quickstart.mdx) to install Dynamo Kubernetes Platform.
Then deploy to kubernetes using

```bash
export NAMESPACE=<your-namespace>
cd dynamo
kubectl apply -f examples/custom_backend/hello_world/basic/deploy/hello_world.yaml -n ${NAMESPACE}
```
...
Continue to [`engine/`](../engine/README.md): a complete custom engine on the
unified backend contract, served through the standard OpenAI-compatible
