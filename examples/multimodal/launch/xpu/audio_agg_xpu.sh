...
MAX_MODEL_LEN=4096 # reduce KV cache memory usage to fit within B60 VRAM
...
ZE_AFFINITY_MASK=0 python3 $SCRIPT_DIR/../../components/audio_encode_worker.py --model $MODEL_NAME &
