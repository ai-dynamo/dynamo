...
**Full guide:** [docs/kubernetes/cloud-providers/eks/eks.md](../../../docs/fern/kubernetes/cloud-providers/eks/eks.md)

**Related guides:**

- [Amazon EFS setup](../../../docs/fern/kubernetes/cloud-providers/eks/efs.md)
- [Elastic Fabric Adapter (EFA)](../../../docs/fern/kubernetes/cloud-providers/eks/efa.md)
