...
> [!Note]: 
> Nodes used for benchmarking were part of a cluster connected via 
> InfiniBand NDR with 8 connections for compute and 2 for storage. 
> Both fabrics were on their own fat tree non-blocking topology. 
