...
#
# Run benchmark with PER-REQUEST scheduler - 8:1 split ratio
...
echo "=========================================="
echo "Per-Request Scheduler Benchmark (8:1)"
echo "=========================================="
echo "Model: $MODEL"
...
# Start server with per-request scheduler
echo "Starting server with per-request scheduler (split: $SPLIT_RATIO)..."
