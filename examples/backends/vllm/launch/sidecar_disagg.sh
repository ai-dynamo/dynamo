...
#
# Disaggregated 1P1D serving via the vLLM gRPC sidecar (2 GPUs).
#
# Five processes:
...
# vLLM gRPC service. The engine derives its KV role from
...
# in-process disagg path; the sidecars relay kv_transfer_params across the
# Dynamo boundary.
