...
TEMP_DIR="/tmp/lora_download_${LORA_NAME}"
...
show_help() {
    ...
    echo "  HF_LORA_REPO  Hugging Face repository (default: gauravprasadgp/Qwen3-0.6B_nlp_to_sql)"
    echo "  LORA_NAME     Local name for the LoRA (default: Qwen3-0.6B-sql)"
    echo ""
    echo "Examples:"
    echo "  $0                                    # Full setup"
