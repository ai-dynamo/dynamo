...
More configurations please refer to https://github.com/ai-dynamo/dynamo/tree/main/examples/managed_k8s/gke/vllm
...
For example, refer to the following from [`examples/managed_k8s/gke/vllm/disagg_gke.yaml`](./vllm/disagg_gke.yaml)
...
```bash
cd dynamo/examples/managed_k8s/gke/vllm
