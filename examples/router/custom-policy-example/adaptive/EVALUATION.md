...
| AIMD | Add distribution weight under skew; slowly reduce it after recovery | Implemented. Small state and hysteresis; strongest candidate across this matrix. This borrows a control-law shape, not a proof of routing stability or fairness from TCP. [Chiu and Jain](https://www.cs.wustl.edu/~jain/papers/cong_av.htm). |
