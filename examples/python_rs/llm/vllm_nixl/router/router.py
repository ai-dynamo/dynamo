...
async def worker(runtime: DistributedRuntime, args: Namespace):
    ...
    Serve the dynemo-init.router.generate endpoint.
    """
    workers_client = (
    ...
    kv_listener = runtime.namespace("dynemo-init").component("vllm")
    await kv_listener.create_service()

    router_component = runtime.namespace("dynemo-init").component("router")
