...
|---|:----:|:----------:|:--:|
| [**分离式服务**](docs/translations/zh-CN/design-docs/disagg-serving.md) | ✅ | ✅ | ✅ |
| [**KV 感知路由**](docs/translations/zh-CN/components/router/README.md) | ✅ | ✅ | ✅ |
| [**基于 SLA 的 Planner**](docs/translations/zh-CN/components/planner/planner-guide.md) | ✅ | ✅ | ✅ |
| [**KVBM**](docs/translations/zh-CN/components/kvbm/README.md) | 🚧 | ✅ | ✅ |
| [**多模态**](https://docs.nvidia.com/dynamo/user-guides/multimodal) | ✅ | ✅ | ✅ |
| [**工具调用**](docs/translations/zh-CN/tool-calling/README.md) | ✅ | ✅ | ✅ |
...
**[架构深入解析 →](docs/translations/zh-CN/design-docs/architecture.md)**

### 核心能力

| 能力 | 作用 | 价值 |
|------|------|------|
| [**分离式预填充/解码**](docs/translations/zh-CN/design-docs/disagg-serving.md) | 将预填充和解码拆分为可独立扩缩容的 GPU 池 | 最大化 GPU 利用率；每个阶段都运行在针对其工作负载调优的硬件上 |
| [**KV 感知路由**](docs/translations/zh-CN/components/router/README.md) | 根据 worker 负载和 KV 缓存重叠度路由请求 | 消除冗余预填充计算，TTFT 快 2x |
| [**KV Block Manager (KVBM)**](docs/translations/zh-CN/components/kvbm/README.md) | 在 GPU → CPU → SSD → 远程存储之间卸载 KV 缓存 | 将有效上下文长度扩展到 GPU 显存之外 |
| [**ModelExpress**](https://github.com/ai-dynamo/modelexpress) | 通过 NIXL/NVLink 在 GPU 之间流式传输模型权重 | 新副本冷启动快 7x |
| [**Planner**](docs/translations/zh-CN/components/planner/planner-guide.md) | 由 SLA 驱动的自动扩缩容器，可分析工作负载并调整资源池规模 | 以最低总体拥有成本（TCO）满足延迟目标 |
...
| [**容错**](docs/translations/zh-CN/fault-tolerance/request-migration.md) | 金丝雀健康检查 + 运行中请求迁移 | worker 可以失败，但用户请求不应失败 |
...
> **注意：** TensorRT-LLM 需要配合 `--extra-index-url https://pypi.nvidia.com` 使用 `pip`。TRT-LLM 专用说明请参阅[安装指南](docs/translations/zh-CN/getting-started/local-installation.md)。

然后按上面的方式启动 frontend 和一个 worker。系统依赖和后端专用说明请参阅[完整安装指南](docs/translations/zh-CN/getting-started/local-installation.md)。
...
适用于希望在本地构建和开发的贡献者。详情请参阅[完整构建指南](docs/translations/zh-CN/getting-started/building-from-source.md)。
...
- **[贡献指南](docs/translations/zh-CN/contribution-guide.md)** — 如何贡献代码、文档和配方
...
- **[SLA 驱动部署](docs/translations/zh-CN/components/planner/planner-guide.md)** – 优化部署以满足 SLA 要求
...
[disagg]: docs/translations/zh-CN/design-docs/disagg-serving.md
[kv-routing]: docs/translations/zh-CN/components/router/README.md
[planner]: docs/translations/zh-CN/components/planner/planner-guide.md
[kvbm]: docs/translations/zh-CN/components/kvbm/README.md
[migration]: docs/translations/zh-CN/fault-tolerance/request-migration.md
[lora]: examples/backends/vllm/deploy/lora/README.md
[tools]: docs/translations/zh-CN/tool-calling/README.md
