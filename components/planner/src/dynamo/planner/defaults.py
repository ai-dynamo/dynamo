...
class SGLangComponentName:
    prefill_worker_k8s_name = "prefill" # use short name to stay within k8s limits with grove
    prefill_worker_component_name = "worker"
    prefill_worker_endpoint = "generate"
    decode_worker_k8s_name = "decode" # use short name to stay within k8s limits with grove
