...
def build_sampling_params(
    ...
    if model_max_len is not None:
        ...
        # provided == dynamic_default is the frontend's auto-fill; treat it as
        # omitted and cap to the configured generation default (else remaining).
        configured_default = default_sampling_params.get("max_tokens", dynamic_default)
        if provided_max_tokens is None or provided_max_tokens == dynamic_default:
