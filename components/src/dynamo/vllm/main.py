...
from .health_check import VllmOmniHealthCheckPayload
...
async def worker() -> None:
    ...
    if WorkerFactory.handles(config):
        ...
        # NOTE: Omni initialization needs to be revisited closely as
        # internally it diverges a lot from P/D worker, i.e. KV event,
        # metrics, etc. Should understand it more and decide whether it
        # should merge into WorkerFactory or stay separate.
