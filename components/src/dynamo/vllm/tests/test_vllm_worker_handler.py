...
class TestLoadQwenGridParams:
    ...
    def test_decode_embedding_dim(self, deepstack_config, expected_decode_embedding_dim):
        from dynamo.vllm.multimodal_utils.models import qwen
        ...
        with (
            patch.object(
                qwen.AutoImageProcessor, "from_pretrained", return_value=processor
            ),
            patch.object(
                qwen.AutoConfig,
                "from_pretrained",
            ...
            params = qwen.load_qwen_grid_params("Qwen/Qwen3-VL-2B-Instruct")
