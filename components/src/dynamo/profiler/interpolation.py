...
"""Real-GPU interpolation curve generation for thorough-mode sweeps.
...
async def run_interpolation(
    ...
    short-circuits here because its interpolation is handled by the planner
    (AIC in-process) and the mocker (``--aic-perf-model`` at runtime).
    """
