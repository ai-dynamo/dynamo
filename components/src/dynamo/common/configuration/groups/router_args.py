...
class RouterArgGroup(ArgGroup):
    ...
    def add_arguments(self, parser) -> None:
        ...
        add_argument(
            ...
            default="hard",
            help=(
                "How an existing session binding participates in KV worker selection. "
                "hard pins the bound worker and bypasses selection policies; soft "
                "provides the binding as a policy-visible preference."
            ),
            choices=("hard", "soft"),
