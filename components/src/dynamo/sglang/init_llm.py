...
from dynamo.sglang.gateway import serve_via_gateway_children, wants_gateway
...
async def init_decode(
    ...
    if snapshot_engine is None and wants_gateway(server_args):
        # engine.tokenizer_manager is a MultiTokenizerRouter here: no generate_request.
        # Children serve; this process only keeps the engine alive.
        await serve_via_gateway_children(engine, server_args, shutdown_event)
        return
