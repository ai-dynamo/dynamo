...
def _get_hicache_native_offloading_capacity(
    scheduler_info: dict[str, Any],
) -> Optional[dict[str, int]]:
    return native_offloading_capacity(scheduler_info.get("hicache_host_total_tokens"))
...
async def _get_runtime_config(
    ...
    try:
        offloading_capacity = _get_hicache_native_offloading_capacity(scheduler_info)
