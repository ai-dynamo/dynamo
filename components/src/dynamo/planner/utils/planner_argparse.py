...
from dynamo.planner.planner_args import PlannerArgGroup
...
def create_sla_planner_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="SLA Planner", formatter_class=argparse.RawTextHelpFormatter
    )
    PlannerArgGroup().add_arguments(parser)
    return parser
