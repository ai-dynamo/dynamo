...
"""Dynamo Planner implementation of the Spica simulation-adapter ABI."""
...
def _planner_config_payload(
    ...
    *,
    ...
    """Build the exact PlannerConfig payload used by the pre-refactor Spica."""
...
def create_adapter() -> DynamoPlannerSimulationAdapter:
    """Create the entry-point registered Planner simulation adapter."""

    return DynamoPlannerSimulationAdapter()
