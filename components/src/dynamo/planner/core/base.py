...
class NativePlannerBase:
    ...
    async def _async_init(self) -> None:
        ...
        # Resolve the per-replica GPU totals for the power gauges once, now that
        # the component names are final. Doing it here (off the tick loop) keeps
        # _publish_power_budget_metrics free of apiserver I/O.
