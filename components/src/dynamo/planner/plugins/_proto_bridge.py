...
_PYD_TO_PROTO: dict[Type[BaseModel], Type[Message]] = {
    ...
    pyd.BatchJobDemand: pb.BatchJobDemand,
    pyd.PoolTrafficDemand: pb.PoolTrafficDemand,
    pyd.BatchDispatcherFeedback: pb.BatchDispatcherFeedback,
    pyd.BatchSchedulingData: pb.BatchSchedulingData,
