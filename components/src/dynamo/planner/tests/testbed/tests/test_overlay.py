...
def _observe(overlay, tick: int = 0) -> tuple[float, float]:
    ...
    fpm = [
        ...
        {"component": "decode", "sum_prefill_tokens": 0, "sum_decode_kv_tokens": 100_000},
    ]
...
class TestOverlayDeterminism:
    ...
    def test_different_seeds_differ(self):
        ...
        assert not math.isclose(d_a, d_b, rel_tol=1e-4), (
...
class TestOverlayBiasPropagation:
    ...
    def test_decode_bias_does_not_affect_prefill(self):
        ...
        assert math.isclose(p_base, p_biased, rel_tol=1e-3), (
