...
- **User docs**: [Planner Guide](../../../../fern/pages/components/planner/planner-guide.md) (deployment, configuration, examples)
- **Design docs**: [Planner Design](../../../../fern/pages/design-docs/planner-design.md) (architecture, algorithms)
