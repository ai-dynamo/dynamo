...
"""Dynamo Router implementation of the Spica simulation-adapter ABI."""
...
def create_adapter() -> DynamoRouterSimulationAdapter:
    """Create the entry-point registered Router simulation adapter."""

    return DynamoRouterSimulationAdapter()
