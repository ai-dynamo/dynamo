...
# Behavioral bounds with self-consistent Rust defaults. Deployments override them through
# `DYN_RELAY_<KEY>` environment variables; they are deliberately not CLI flags because their
# values are validated against each other by the Rust configuration, not chosen per deployment.
