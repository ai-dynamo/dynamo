...
class TestMakeBackendError:  # FE.response_misc.8 — BackendError construction
...
class TestMakeInternalError:  # FE.response_misc.8 — InternalError construction
...
class TestHandleEngineError:  # FE.response_misc.8 — engine error → HTTP-friendly mapping
