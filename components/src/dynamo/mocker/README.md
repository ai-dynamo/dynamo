...
**Expected directory structure for custom profiling results:**
```
profiling_results/
├── prefill.npz  # Contains prefill_isl, prefill_ttft, prefill_thpt_per_gpu
├── decode.npz   # Contains x_kv_usage, y_context_length, z_itl
└── perf_data.npz  # Generated by converter - use this with --planner-profile-data
```
...
4. If interpolation fails (e.g., out-of-bounds query), it returns 0.0 and logs a debug message
