...
#[ignore = "requires CAP_NET_ADMIN and currently expects to fail for issue #7864"]
async fn standalone_listener_recovers_after_blackhole_partition() -> Result<()> {
    ...
    // TODO(#7864): this expects to fail today until the standalone listener
    // tears down the dead SUB socket and reconnects after blackhole recovery.
    let recovered_count =
