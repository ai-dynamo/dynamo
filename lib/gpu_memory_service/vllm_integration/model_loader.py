...
def register_gms_loader(load_format: str = "gms") -> None:
    ...
    class GMSModelLoader(BaseModelLoader):
        ...
        def __init__(self, load_config):
            ...
            self.stripped_load_config = replace(
                strip_gms_extra_config(load_config), load_format="auto"
            )
...
def _resolve_device(vllm_config) -> tuple[int, torch.device]:
    """Determine target CUDA device index and device object."""
    ...
    return device_index, target_device
