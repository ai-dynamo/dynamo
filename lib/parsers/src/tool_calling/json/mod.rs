...
mod tests {
    ...
    /// of the upstream stream-end reason. Real PARSER.12 coverage (stop /
    ...
    /// PARSER.6 — empty args. A no-arg call (`{}`) must still be returned
    /// with the function name intact.
    #[test] // PARSER.6 — nemotron_deci
