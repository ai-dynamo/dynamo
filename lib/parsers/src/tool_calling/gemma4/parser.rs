...
mod tests {
    ...
    #[test] // PARSER.1 — single string argument
    ...
    #[test] // PARSER.1, PARSER.7 — multiple typed arguments
    ...
    #[test] // PARSER.6 — empty argument object
    ...
    #[test] // PARSER.7 — nested object value
    ...
    #[test] // PARSER.7 — array of strings
    ...
    #[test] // PARSER.7 — array of mixed primitives
    ...
    #[test] // PARSER.2 — multiple parallel calls, zero spacing
    ...
    #[test] // PARSER.13 — surrounding normal text preserved
    ...
    #[test] // PARSER.3 — no tool calls at all
    ...
    #[test] // PARSER.5 — complete prior calls survive; truncated tail is echoed
    ...
    #[test] // PARSER.4 — malformed args body falls back to empty object, call still emitted
    ...
    #[test] // PARSER.fmt1 — function names with hyphens, dots, underscores
    ...
    #[test] // PARSER.7 — angle brackets / HTML inside string values
    ...
    #[test] // PARSER.7 — newlines inside string values
    ...
    #[test] // PARSER.fmt2 — whitespace tolerance inside args
    ...
    #[test] // PARSER.7 — negative numbers and floats
    ...
    #[test] // PARSER.fmt1 — tool validation warns but doesn't drop
    ...
    #[test] // PARSER.fmt4 — empty wrapper between calls
    ...
    #[test] // PARSER.6 — empty args at the grammar entry point
    fn args_grammar_empty() {
        let v = parse_args_object("").unwrap();
        assert_eq!(v, serde_json::json!({}));
    }

    #[test] // PARSER.7 — string with comma/colon/brace literals
    ...
    #[test] // PARSER.4, PARSER.5 — truncated string-arg recovery (mirrors upstream)
    ...
    #[test] // PARSER.4 — empty value mid-args (upstream test_empty_value)
    ...
    #[test] // PARSER.4 — empty value at end-of-args (upstream test_empty_value)
    ...
    #[test] // PARSER.7 — typed-value null variants, case-insensitive (upstream `value_str.lower() in (...)`)
    ...
    #[test] // PARSER.4 — keyword-prefix must not partial-match (`nullable` vs `null`)
    ...
    #[test] // PARSER.5 — missing end-marker, raw bytes echoed (upstream test_incomplete_tool_call)
    ...
    #[test] // PARSER.7 — `<tool_call|>` literal inside a string-typed argument
    ...
    #[test] // PARSER.9 — paired reasoning span + tool call in the same emission
    ...
    #[test] // PARSER.14 — empty input, no tool calls
    ...
    #[test] // PARSER.14 — `null` argument values round-trip as JSON null
    ...
    #[test] // PARSER.15 — duplicate calls to the same function name. Both must
    ...
    //
    // PARSER.8  — Streaming token-by-token assembly: indirect. The Gemma 4
    ...
    // PARSER.11 — `tool_choice` (auto / required / named / none): universal gap
    ...
    // PARSER.12 — `finish_reason` semantics: same universal gap; lives in
    //           `lib/llm/tests/tool_choice_finish_reasons.rs`, hermes-only
    //           today.
    // PARSER.xml1 / PARSER.xml2 — XML-family only. N/A — Gemma 4 uses a custom
    //           non-JSON, non-XML grammar.
    // PARSER.harmony1 / PARSER.harmony2 — Harmony only. N/A.
}
