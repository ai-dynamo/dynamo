...
pub(crate) type RegisteredReturnFn<T> =
    Arc<dyn Fn(Arc<super::blocks::Block<T, super::blocks::state::Registered>>) + Send + Sync>;
...
impl BlockRegistry {
    ...
    pub fn check_presence<T: super::blocks::BlockMetadata>(
        &self,
