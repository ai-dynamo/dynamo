...
pub(crate) use inactive::{InactivePool, InactivePoolBackend, backends};
pub(crate) use reset::ResetPool;

// Re-export RAII guards from guards module
use super::blocks::{
    Block, BlockId, BlockMetadata, BlockRegistry, ImmutableBlock, MutableBlock, PrimaryBlock,
    RegisteredBlock,
    state::{Registered, Reset},
};

pub(crate) use super::SequenceHash;
...
pub use super::blocks::BlockDuplicationPolicy;
