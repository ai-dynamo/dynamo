...
mod tests {
    ...
    fn loads_agentic_request_trace_rows_and_tool_events() {
        ...
        writeln!(
            file,
            r#"{{"schema":"dynamo.request.trace.v1","event_type":"request_end","event_time_unix_ms":1100,"event_source":"dynamo","agent_context":{{"session_type_id":"ms_agent","session_id":"run-1","trajectory_id":"root"}},"request":{{"request_id":"req-1","model":"test","request_received_ms":1000,"output_tokens":4,"replay":{{"trace_block_size":2,"input_length":3,"input_sequence_hashes":[11,22]}}}}}}"#
        )
        .unwrap();
        writeln!(
            file,
            r#"{{"schema":"dynamo.request.trace.v1","event_type":"tool_end","event_time_unix_ms":1200,"event_source":"harness","agent_context":{{"session_type_id":"ms_agent","session_id":"run-1","trajectory_id":"root"}},"tool":{{"tool_call_id":"tool-1","tool_class":"search","started_at_unix_ms":1110,"ended_at_unix_ms":1200,"status":"succeeded","duration_ms":90}}}}"#
        )
        .unwrap();
