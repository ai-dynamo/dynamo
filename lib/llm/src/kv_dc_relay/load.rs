...
pub(crate) struct PoolLoadSnapshot {
    pub(crate) producer: ProducerIdentity,
    pub(crate) kv_used_blocks: u64,
    pub(crate) total_kv_blocks: u64,
    pub(crate) kv_observed_ranks: usize,
    pub(crate) kv_expected_ranks: usize,
    pub(crate) active_decode_blocks: u64,
    pub(crate) decode_observed_ranks: usize,
    pub(crate) decode_expected_ranks: usize,
    pub(crate) active_prefill_tokens: u64,
    pub(crate) prefill_token_capacity: u64,
    pub(crate) prefill_observed_ranks: usize,
    pub(crate) prefill_expected_ranks: usize,
}

impl PoolLoadSnapshot {
    pub(crate) fn has_degraded_coverage(self) -> bool {
