...
impl OpenAIPreprocessor {
    ...
    /// tool-call parser. K2 forced requests and named K3 requests intrinsically use
    /// their native structural tags because generic JSON cannot represent their
    /// tool calls. Other forced choices fall back to the legacy JSON-schema
    /// constraint when structural tags are not applied.
