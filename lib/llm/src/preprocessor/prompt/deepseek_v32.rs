...
fn render_message(
    ...
    match role {
        ...
        "assistant" => {
            ...
            //
            // Prefer reasoning_segments (interleaved) joined into one block; fall back to the
            // flat reasoning_content string. DeepSeek V3.2 always places its <think> block
            // before all tool calls, so joining segments produces the correct flat form here.
