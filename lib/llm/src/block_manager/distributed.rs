...
pub use g3pb::{
    ...
    G3PB_NAMESPACE, G3pbCommitRequest, G3pbError, G3pbFetchBlocksResponse, G3pbFetchRequest,
    G3pbFetchResponse, G3pbHealthResponse, G3pbLoadRemoteRequest, G3pbOfferRequest,
