...
use crate::protocols::common::extensions::{
    NvExt, NvExtProvider, merge_response_nvext, validate_completion_token_ids_single_choice,
};
...
pub struct ResponseExtensions {
    ...
    pub seed: Option<i64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub stop: Option<dynamo_protocols::types::Stop>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl NvExtProvider for NvCreateResponse {
    ...
    fn unsupported_fields(&self) -> Option<&HashMap<String, serde_json::Value>> {
        Some(&self.extensions.unsupported_fields)
    }
}
...
impl OpenAISamplingOptionsProvider for NvCreateResponse {
    ...
    fn get_frequency_penalty(&self) -> Option<f32> {
        self.extensions.frequency_penalty
    }

    fn get_presence_penalty(&self) -> Option<f32> {
        self.extensions.presence_penalty
    }
...
impl CommonExtProvider for NvCreateResponse {
    fn common_ext(&self) -> Option<&CommonExt> {
        Some(&self.extensions.common)
    }

    fn get_guided_json(&self) -> Option<serde_json::Value> {
        if let Some(value) = self.extensions.common.guided_json.clone() {
            return Some(value);
        }
        self.inner
            .text
    ...
    fn get_guided_regex(&self) -> Option<String> {
        self.extensions.common.guided_regex.clone()
    }

    fn get_guided_grammar(&self) -> Option<String> {
        self.extensions.common.guided_grammar.clone()
    }

    fn get_guided_choice(&self) -> Option<Vec<String>> {
        self.extensions.common.guided_choice.clone()
    }

    fn get_guided_decoding_backend(&self) -> Option<String> {
        self.extensions.common.guided_decoding_backend.clone()
    }

    fn get_guided_whitespace_pattern(&self) -> Option<String> {
        self.extensions.common.guided_whitespace_pattern.clone()
    }

    fn get_top_k(&self) -> Option<i32> {
        self.extensions.common.top_k
    }

    fn get_min_p(&self) -> Option<f32> {
        self.extensions.common.min_p
    }

    fn get_repetition_penalty(&self) -> Option<f32> {
        self.extensions.common.repetition_penalty
    }

    fn get_include_stop_str_in_output(&self) -> Option<bool> {
        self.extensions.common.include_stop_str_in_output
    }

    fn get_skip_special_tokens(&self) -> Option<bool> {
        self.extensions.common.skip_special_tokens
    }

    fn get_prompt_logprobs_count(&self) -> Option<u32> {
        self.extensions.common.prompt_logprobs
    }
}
...
impl OpenAIStopConditionsProvider for NvCreateResponse {
    ...
    fn get_min_tokens(&self) -> Option<u32> {
        self.extensions.common.min_tokens
    }
    ...
    fn get_common_ignore_eos(&self) -> Option<bool> {
        self.extensions.common.ignore_eos
    }
...
impl ValidateRequest for NvCreateResponse {
    fn validate(&self) -> Result<(), anyhow::Error> {
        validate::validate_no_unsupported_fields(&self.extensions.unsupported_fields)?;
        if let Some(model) = self.inner.model.as_deref() {
            validate::validate_model(model)?;
        }
        validate::validate_frequency_penalty(self.extensions.frequency_penalty)?;
        validate::validate_presence_penalty(self.extensions.presence_penalty)?;
        ...
        validate::validate_stop(&self.extensions.stop)?;
        validate::validate_user(self.extensions.user.as_deref())?;
        validate::validate_repetition_penalty(self.extensions.common.repetition_penalty)?;
        validate::validate_min_p(self.extensions.common.min_p)?;
        validate::validate_top_k(self.extensions.common.top_k)?;
        validate_completion_token_ids_single_choice(1, self.nvext.as_ref())?;
        Ok(())
    }
}
...
impl TryFrom<NvCreateResponse> for NvCreateChatCompletionRequest {
    ...
    fn try_from(resp: NvCreateResponse) -> Result<Self, Self::Error> {
        ...
        let common = resp.extensions.common.clone();
        ...
        Ok(NvCreateChatCompletionRequest {
            inner: CreateChatCompletionRequest {
                ...
                frequency_penalty: resp.extensions.frequency_penalty,
                presence_penalty: resp.extensions.presence_penalty,
                seed: resp.extensions.seed,
                user: resp.extensions.user,
            ...
            unsupported_fields: resp.extensions.unsupported_fields,
        })
    }
}
...
mod tests {
    ...
    fn test_rl_token_sampling_extensions_forwarded_to_chat_request() {
        ...
        response_req.extensions.common.ignore_eos = Some(true);
        response_req.extensions.common.min_tokens = Some(7);
        response_req.extensions.common.top_k = Some(20);
        response_req.extensions.stop =
