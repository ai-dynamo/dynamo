...
use crate::preprocessor::prompt::prompt_formatter_from_mdc_with_chat_template;
...
fn render_tokenize_chat_tokens(
    ...
    let formatter =
        prompt_formatter_from_mdc_with_chat_template(card, request.chat_template.as_deref())
