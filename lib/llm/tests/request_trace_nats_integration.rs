    ...
    async fn test_request_trace_nats_basic_flow() {
        ...
        async_with_vars(
            ...
            async {
                ...
                let handle = payload::create_handle(&request, "test-req-1", None, None)
    ...
    async fn test_request_trace_nats_request_payload_records_ignore_store_flag() {
        ...
        async_with_vars(
            ...
            async {
                ...
                payload::create_handle(&request_true, "store-true", None, None)
                    .expect("store=true handle")
                    .emit(None);

                let request_false = create_test_request("nemotron", false);
                payload::create_handle(&request_false, "store-false", None, None)
