...
fn _core(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<Component>()?; // Public API (used in examples/)
    ...
    m.add_class::<llm::local_model::ModelRuntimeConfig>()?; // Public API (used in examples/)
    ...
    m.add_class::<context::Context>()?; // Public API (used in examples/)
