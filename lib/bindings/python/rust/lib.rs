...
fn _core(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<llm::preprocessor::MediaPreprocessor>()?;
...
fn register_model<'p>(
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        ...
        builder
            ...
            .media_preprocessor(media_preprocessor.map(|m| m.inner))
