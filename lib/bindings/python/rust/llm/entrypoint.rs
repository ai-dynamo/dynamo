...
impl KvRouterConfig {
    ...
    fn new(
        ...
        router_predict_on_route: bool,
        router_predicted_ttl_secs: f64,
    ) -> Self {
        KvRouterConfig {
            inner: RsKvRouterConfig {
