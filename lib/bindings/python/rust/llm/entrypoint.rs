...
impl EntrypointArgs {
    ...
    #[new]
    #[pyo3(signature = (engine_type, model_path=None, model_name=None, model_config=None, endpoint_id=None, context_length=None, template_file=None, router_config=None, kv_cache_block_size=None, http_host=None, http_port=None, tls_cert_path=None, tls_key_path=None, extra_engine_args=None, namespace=None, nim_metrics_polling_interval_seconds=0.0, nim_metrics_on_demand=false))]
    pub fn new(
        engine_type: EngineType,
        model_path: Option<PathBuf>,
        ...
        if nim_metrics_polling_interval_seconds > 0.0 && nim_metrics_on_demand {
            return Err(pyo3::exceptions::PyValueError::new_err(
                "nim_metrics_polling_interval_seconds > 0 and nim_metrics_on_demand cannot be used together",
            ));
        }
        Ok(EntrypointArgs {
            engine_type,
...
pub fn make_engine<'p>(
    ...
    builder
        ...
        .nim_metrics_polling_interval_seconds(args.nim_metrics_polling_interval_seconds)
        .nim_metrics_on_demand(args.nim_metrics_on_demand);
