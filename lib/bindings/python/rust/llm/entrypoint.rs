...
use dynamo_kv_router::config::{
    KvRouterConfig as RsKvRouterConfig, RouterDecodeLoadModel as RsRouterDecodeLoadModel,
...
impl KvRouterConfig {
    ...
    fn new(
        ...
        let inner = RsKvRouterConfig {
            ...
            decode_load_model: decode_load_model
                .parse::<RsRouterDecodeLoadModel>()
    ...
    #[getter]
    fn decode_load_model(&self) -> String {
        self.inner.decode_load_model.to_string()
    }

    #[setter]
    fn set_decode_load_model(&mut self, value: &str) -> PyResult<()> {
        self.inner.decode_load_model = value
            .parse::<RsRouterDecodeLoadModel>()
            .map_err(PyValueError::new_err)?;
        Ok(())
    }
