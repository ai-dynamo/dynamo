...
impl KvRouterConfig {
    ...
    fn new(
        ...
        remote_g2_reuse_enabled: bool,
        remote_g2_cost_blocks: f64,
        remote_g2_cost_per_block: f64,
        remote_g2_max_planned_blocks: Option<u32>,
        remote_g2_max_local_overlap_gap_blocks: Option<u32>,
    ) -> Self {
        KvRouterConfig {
            inner: RsKvRouterConfig {
