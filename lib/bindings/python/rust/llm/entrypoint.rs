...
pub(crate) struct EntrypointArgs {
    ...
    mocker_wait_for_endpoint_instance: bool,
...
impl EntrypointArgs {
    #[allow(clippy::too_many_arguments)]
    #[new]
    #[pyo3(signature = (engine_type, model_path=None, model_name=None, endpoint_id=None, template_file=None, router_config=None, kv_cache_block_size=None, http_host=None, http_port=None, http_metrics_port=None, tls_cert_path=None, tls_key_path=None, extra_engine_args=None, mocker_engine_args=None, mocker_wait_for_endpoint_instance=true, runtime_config=None, namespace=None, namespace_prefix=None, is_prefill=false, is_decode=false, migration_limit=0, migration_max_seq_len=None, chat_engine_factory=None, aic_perf_config=None, *, metrics_prefix=None, enable_anthropic_api=None, strip_anthropic_preamble=None, enable_streaming_tool_dispatch=None, enable_streaming_reasoning_dispatch=None, reasoning_field_name=None, tokenizer_backend=None, tokenizer_fallback=None))]
    pub fn new(
        py: Python<'_>,
        engine_type: EngineType,
        model_path: Option<PathBuf>,
        ...
        Ok(EntrypointArgs {
            ...
            extra_engine_args,
            mocker_engine_args,
            mocker_wait_for_endpoint_instance,
            runtime_config,
            namespace,
            namespace_prefix,
            is_prefill,
    ...
    let inner = match args.engine_type {
        ...
        EngineType::Mocker => {
            ...
            let engine = make_mocker_engine(
                ...
                endpoint,
                mocker_args,
                args.mocker_wait_for_endpoint_instance,
            )
            .await?;
