...
use dynamo_kv_router::config::{
    DEFAULT_ROUTER_QUEUE_DEPTH_PER_WORKER, KvRouterConfig as RsKvRouterConfig,
...
impl KvRouterConfig {
    ...
    fn new(
        ...
        router_queue_depth_by_missing_isl: Vec<(usize, usize)>,
    ) -> PyResult<Self> {
