...
impl MockEngineArgs {
    ...
    fn dump_json(&self) -> PyResult<String> {
        ...
        let payload = json!({
            ...
            "kv_transfer_abort_timeout_ms": self.inner.kv_transfer_abort_timeout_ms,
