...
impl WorkerConfig {
    ...
    fn new(
        ...
        backend_media_decoder: Option<MediaDecoder>,
        backend_media_fetcher: Option<MediaFetcher>,
    ) -> PyResult<Self> {
        ...
        Ok(Self {
            inner: RsWorkerConfig {
                ...
                route_to_encoder,
                backend_media_decoder: backend_media_decoder.map(|decoder| decoder.inner),
                backend_media_fetcher: backend_media_fetcher.map(|fetcher| fetcher.inner),
            },
        })
    }
}
