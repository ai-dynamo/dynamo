...
def _patch_memory(monkeypatch, return_value=123):
    """Patch AISim's unified estimator and record forwarded kwargs.
...
def test_runtime_loader_does_not_import_legacy_aiconfigurator(monkeypatch):
    """The mocker/runtime path uses the current AISim core namespace."""
