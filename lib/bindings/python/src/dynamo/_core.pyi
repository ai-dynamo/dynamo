    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            decode_active_request_weight: Experimental block-equivalent decode cost added for each potential active request on a candidate worker, including the incoming request (default: 0.0)
