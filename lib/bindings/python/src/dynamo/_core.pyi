    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            conditional_disagg_decode_busy_threshold: Decode-busy guard threshold that disables bypass when the selected decode worker reports it is holding more than this fraction of its KV capacity. This reads the worker's own report, not the router's logical estimate, so a value tuned before that change reads roughly 3x lower than the traffic it was tuned on. Recalibrate it (default: None).
