...
class PerformanceMetricsRegistry:
    ...
    def new_rate_metric(self, name: str, quantiles: Optional[List[float]] = None, sample_period_seconds: float = 1.0) -> RateMetric: ...
    def new_distribution_metric(self, name: str, quantiles: Optional[List[float]] = None) -> DistributionMetric: ...
    def new_ratio_metric(self, name: str, quantiles: Optional[List[float]] = None) -> RatioMetric: ...
    def attach_runtime_metrics(self, runtime_metrics: Any, metric_prefix: str = "performance", labels: Optional[List[Tuple[str, str]]] = None) -> None: ...
