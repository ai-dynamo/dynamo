...
class AicSession:
    ...
    def __init__(
        ...
        for cfg_key, field, dtype in (
            ("gemm_quant_mode", "gemm", weight_dtype),
            ("moe_quant_mode", "moe", moe_dtype),
            ("fmha_quant_mode", "fmha", activation_dtype),
...
def estimate_num_gpu_blocks(
    ...
    return int(
        memory.estimate_num_gpu_blocks(
            ...
            moe_tp_size=moe_tp_size,
            moe_ep_size=moe_ep_size,
            gemm_quant_mode=_resolve_quant_mode_name("gemm", weight_dtype),
            moe_quant_mode=_resolve_quant_mode_name("moe", moe_dtype),
            fmha_quant_mode=_resolve_quant_mode_name("fmha", activation_dtype),
