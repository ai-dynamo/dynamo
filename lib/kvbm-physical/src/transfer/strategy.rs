...
pub enum TransferStrategy {
    ...
    /// Async host-to-device transfer (CUDA/XPU)
    AsyncH2D,

    /// Async device-to-host transfer (CUDA/XPU)
    AsyncD2H,

    /// Async device-to-device transfer (CUDA/XPU)
    AsyncD2D,
    ...
    /// Blocking host-to-device transfer (CUDA/XPU)
    BlockingH2D,

    /// Blocking device-to-host transfer (CUDA/XPU)
    BlockingD2H,
