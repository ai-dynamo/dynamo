...
> **Run:** `20260419_134055` | **Sources:** `kvbench_ze_iter5.log` + `kvbench_sycl_iter5.log` | **Iteration:** 5 of 5
...
| H2D | fc_to_lw | vectorized | pinned | 1.00x |
| H2D | fc_to_lw | memcpy | pinned | 1.00x |
| H2D | fc_to_lw | memcpy | system | 0.99x |
| D2H | fc_to_fc | memcpy | pinned | 1.00x |
| D2H | fc_to_fc | vectorized | pinned | 0.99x |
...
| 32 | 1.00x | 0.98x | 1.00x |
| 64 | 0.98x | 1.00x | 0.99x |
| 128 | 1.02x | 0.99x | 1.00x |
