...
> **Run:** `20260418_171130` | **Sources:** `kvbench_ze_iter3.log` + `kvbench_sycl_iter3.log` | **Iteration:** 3 of 5
...
| D2D | lw_to_fc | vectorized | - | 0.99x |
| D2D | lw_to_fc | memcpy | - | 1.07x |
...
| H2D | lw_to_fc | memcpy | system | 0.94x |
...
| D2H | fc_to_lw | vectorized | pinned | 0.98x |
| D2H | fc_to_lw | memcpy | pinned | 1.00x |
| D2H | fc_to_lw | memcpy | system | 0.97x |
...
| D2H | fc_to_fc | memcpy | pinned | 1.00x |
| D2H | fc_to_fc | vectorized | pinned | 1.00x |
| D2H | fc_to_fc | memcpy | system | 1.03x |
| D2H | lw_to_fc | vectorized | pinned | 1.00x |
| D2H | lw_to_fc | memcpy | pinned | 1.00x |
...
| 4 | 1.00x | 1.00x | 1.00x |
| 8 | 1.00x | 1.00x | 0.99x |
| 16 | 1.00x | 1.00x | 0.98x |
| 32 | 1.00x | 0.99x | 0.98x |
| 64 | 1.02x | 0.98x | 1.00x |
| 128 | 0.98x | 1.00x | 1.00x |
| 256 | 1.00x | 1.00x | 0.98x |
