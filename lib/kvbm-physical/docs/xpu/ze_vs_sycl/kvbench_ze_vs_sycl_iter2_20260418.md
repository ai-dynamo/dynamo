...
> **Run:** `20260418_171130` | **Sources:** `kvbench_ze_iter2.log` + `kvbench_sycl_iter2.log` | **Iteration:** 2 of 5
...
| H2D | fc_to_lw | memcpy | system | 1.01x |
| D2H | fc_to_fc | memcpy | pinned | 1.00x |
| D2H | fc_to_fc | vectorized | pinned | 1.01x |
