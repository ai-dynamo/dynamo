...
> **Run:** `20260419_134055` | **Sources:** `kvbench_ze_iter1.log` + `kvbench_sycl_iter1.log` | **Iteration:** 1 of 5
...
| D2D | lw_to_fc | memcpy | - | 0.98x |
| D2D | fc_to_lw | vectorized | - | 0.98x |
| D2D | fc_to_lw | memcpy | - | 0.98x |
| H2D | fc_to_fc | memcpy | pinned | 1.00x |
| H2D | fc_to_fc | vectorized | pinned | 1.00x |
...
| D2H | fc_to_fc | memcpy | system | 1.01x |
| D2H | lw_to_fc | vectorized | pinned | 1.00x |
| D2H | lw_to_fc | memcpy | pinned | 1.00x |
