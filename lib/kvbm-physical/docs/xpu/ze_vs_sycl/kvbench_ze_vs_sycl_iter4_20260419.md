...
> **Run:** `20260419_134055` | **Sources:** `kvbench_ze_iter4.log` + `kvbench_sycl_iter4.log` | **Iteration:** 4 of 5
...
| H2D | lw_to_fc | memcpy | system | 0.96x |
...
| D2H | fc_to_lw | vectorized | pinned | 0.99x |
...
| 64 | 1.00x | 0.99x | 0.99x |
| 128 | 1.00x | 0.99x | 1.00x |
| 256 | 0.99x | 0.93x | 0.99x |
