...
> **Run:** `20260418_171130` | **Sources:** `kvbench_ze_iter1.log` + `kvbench_sycl_iter1.log` | **Iteration:** 1 of 5
...
| 8 | 1.00x | 1.00x | 1.00x |
| 16 | 1.00x | 1.00x | 0.99x |
| 32 | 1.00x | 1.00x | 0.97x |
| 64 | 1.02x | 0.98x | 1.00x |
| 128 | 0.98x | 1.00x | 0.99x |
| 256 | 1.00x | 0.99x | 1.03x |
