...
> **Run:** `20260418_171130` | **Sources:** `kvbench_sycl_iter5.log` + `transfer_sycl_iter5.log` | **Backend:** SYCL | **Iteration:** 5 of 5
...
**D2D: 0.86x–0.92x** — residual overhead from TM dispatch vs sub-ms raw transfers.
...
| 4 | 0.05x | 0.08x | 0.17x |
| 8 | 0.09x | 0.17x | 0.33x |
| 16 | 0.18x | 0.34x | 0.66x |
| 32 | 0.34x | 0.65x | 0.62x |
| 64 | 0.66x | 0.66x | 0.86x |
| 128 | 0.65x | 0.86x | 0.86x |
| 256 | 0.86x | 0.86x | 0.92x |

**Ratio:** peak 0.52x, avg 0.39x
...
| 4 | 0.05x | 0.09x | 0.20x |
| 8 | 0.09x | 0.18x | 0.39x |
| 16 | 0.18x | 0.35x | 0.76x |
| 32 | 0.33x | 0.68x | 0.73x |
| 64 | 0.65x | 0.66x | 0.74x |
| 128 | 0.65x | 0.84x | 0.86x |
| 256 | 0.85x | 0.88x | 0.86x |
...
| 4 | 0.05x | 0.09x | 0.20x |
| 8 | 0.09x | 0.18x | 0.38x |
| 16 | 0.18x | 0.35x | 0.77x |
| 32 | 0.34x | 0.69x | 0.75x |
...
| 4 | 0.71x | 0.79x | 0.94x |
| 8 | 0.79x | 0.94x | 0.97x |
| 16 | 0.93x | 0.96x | 0.99x |
| 32 | 0.96x | 0.98x | 1.00x |
| 64 | 0.94x | 1.01x | 0.98x |
| 128 | 1.00x | 0.99x | 0.99x |
| 256 | 0.98x | 0.98x | 1.01x |
