...
> **Run:** `20260418_171130` | **Sources:** `kvbench_ze_iter3.log` + `transfer_ze_iter3.log` | **Backend:** Level Zero (ZE) | **Iteration:** 3 of 5
...
| D2H | fc_to_lw | vectorized | 0.97x |

**H2D/D2H: 0.97x–1.00x** — minimal TransferManager overhead.
**D2D: 0.85x–0.95x** — residual overhead from TM dispatch vs sub-ms raw transfers.
...
| 4 | 0.05x | 0.13x | 0.25x |
| 8 | 0.13x | 0.24x | 0.47x |
| 16 | 0.30x | 0.49x | 0.53x |
| 32 | 0.59x | 0.52x | 0.73x |
| 64 | 0.56x | 0.70x | 0.81x |
| 128 | 0.79x | 0.85x | 0.92x |
| 256 | 0.88x | 0.95x | 0.95x |

**Ratio:** peak 0.64x, avg 0.41x
...
| 4 | 0.04x | 0.09x | 0.18x |
| 8 | 0.08x | 0.16x | 0.34x |
| 16 | 0.18x | 0.31x | 0.76x |
| 32 | 0.34x | 0.60x | 0.73x |
| 64 | 0.64x | 0.65x | 0.73x |
| 128 | 0.65x | 0.67x | 0.79x |
| 256 | 0.79x | 0.75x | 0.85x |
...
| 4 | 0.04x | 0.09x | 0.17x |
| 8 | 0.08x | 0.17x | 0.34x |
| 16 | 0.18x | 0.32x | 0.76x |
| 32 | 0.34x | 0.62x | 0.73x |
| 64 | 0.66x | 0.67x | 0.74x |
| 128 | 0.66x | 0.67x | 0.81x |
| 256 | 0.82x | 0.75x | 0.87x |

**Ratio:** peak 0.58x, avg 0.39x
...
| 4 | 0.69x | 0.80x | 0.94x |
| 8 | 0.79x | 0.87x | 0.96x |
| 16 | 0.93x | 0.96x | 0.94x |
| 32 | 0.96x | 0.94x | 0.97x |
| 64 | 0.95x | 0.99x | 0.99x |
| 128 | 0.98x | 0.99x | 0.99x |
| 256 | 0.99x | 0.96x | 0.97x |
