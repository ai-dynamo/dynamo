...
> **Run:** `20260418_171130` | **Sources:** `kvbench_sycl_iter2.log` + `transfer_sycl_iter2.log` | **Backend:** SYCL | **Iteration:** 2 of 5
...
**H2D/D2H: 1.00x–1.02x** — zero measurable TransferManager overhead.
**D2D: 0.85x–0.92x** — residual overhead from TM dispatch vs sub-ms raw transfers.
...
| 4 | 0.05x | 0.08x | 0.15x |
| 8 | 0.09x | 0.17x | 0.25x |
| 16 | 0.17x | 0.33x | 0.56x |
| 32 | 0.31x | 0.62x | 0.57x |
| 64 | 0.66x | 0.65x | 0.78x |
| 128 | 0.66x | 0.86x | 0.85x |
| 256 | 0.76x | 0.86x | 0.92x |

**Ratio:** peak 0.59x, avg 0.37x
...
| 4 | 0.05x | 0.10x | 0.18x |
| 8 | 0.09x | 0.19x | 0.34x |
| 16 | 0.18x | 0.35x | 0.65x |
| 32 | 0.30x | 0.68x | 0.66x |
| 64 | 0.64x | 0.66x | 0.82x |
| 128 | 0.66x | 0.85x | 0.86x |
| 256 | 0.80x | 0.84x | 0.85x |

**Ratio:** peak 0.66x, avg 0.41x
...
| 32 | 0.31x | 0.69x | 0.66x |
| 64 | 0.65x | 0.68x | 0.83x |
| 128 | 0.66x | 0.66x | 0.88x |
| 256 | 0.80x | 0.90x | 0.86x |
...
| 64 | 0.93x | 0.99x | 0.98x |
| 128 | 0.99x | 0.98x | 1.00x |
| 256 | 0.97x | 0.99x | 1.02x |
