...
> **Run:** `20260418_171130` | **Sources:** `kvbench_ze_iter4.log` + `transfer_ze_iter4.log` | **Backend:** Level Zero (ZE) | **Iteration:** 4 of 5
...
| 4 | 0.05x | 0.15x | 0.29x |
| 8 | 0.16x | 0.29x | 0.56x |
| 16 | 0.29x | 0.56x | 0.54x |
| 32 | 0.59x | 0.52x | 0.73x |
| 64 | 0.57x | 0.70x | 0.87x |
| 128 | 0.97x | 0.85x | 0.89x |
| 256 | 0.93x | 0.96x | 0.95x |

**Ratio:** peak 0.64x, avg 0.43x
...
| 4 | 0.04x | 0.10x | 0.20x |
| 8 | 0.09x | 0.19x | 0.39x |
| 16 | 0.17x | 0.36x | 0.75x |
| 32 | 0.34x | 0.69x | 0.74x |
| 64 | 0.64x | 0.65x | 0.73x |
| 128 | 0.57x | 0.67x | 0.85x |
| 256 | 0.85x | 0.76x | 0.85x |

**Ratio:** peak 0.65x, avg 0.40x
...
| 4 | 0.04x | 0.10x | 0.20x |
| 8 | 0.10x | 0.19x | 0.40x |
| 16 | 0.18x | 0.37x | 0.76x |
| 32 | 0.34x | 0.71x | 0.74x |
| 64 | 0.65x | 0.67x | 0.74x |
| 128 | 0.59x | 0.68x | 0.87x |
| 256 | 0.88x | 0.76x | 0.88x |

**Ratio:** peak 0.66x, avg 0.40x
...
| 4 | 0.61x | 0.85x | 0.88x |
| 8 | 0.78x | 0.88x | 0.98x |
| 16 | 0.94x | 0.98x | 0.95x |
| 32 | 0.98x | 0.99x | 0.98x |
| 64 | 0.98x | 1.00x | 0.99x |
...
| 4 | 0.75x | 0.80x | 0.94x |
| 8 | 0.74x | 0.95x | 0.97x |
| 16 | 0.86x | 0.97x | 0.94x |
| 32 | 0.96x | 0.95x | 0.97x |
| 64 | 0.95x | 0.97x | 0.99x |
| 128 | 0.96x | 0.98x | 1.00x |
| 256 | 0.98x | 0.98x | 0.99x |
