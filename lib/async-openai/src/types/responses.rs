...
/// A context item: message, function call, or function call output.
#[derive(ToSchema, Debug, Serialize, Deserialize, Clone, PartialEq)]
#[serde(untagged)]
pub enum InputItem {
    /// A function call generated by the model in a previous turn.
    FunctionCall(InputFunctionCall),
    /// The output of a function call that was executed by the client.
    FunctionCallOutput(InputFunctionCallOutput),
    /// A message to prime the model.
    Message(InputMessage),
    /// An unrecognized input item (forward-compat).
    Custom(serde_json::Value),
}

/// A function call that was generated by the model in a previous turn.
#[derive(ToSchema, Debug, Serialize, Deserialize, Clone, PartialEq)]
pub struct InputFunctionCall {
    /// Must be "function_call".
    #[serde(rename = "type")]
    pub kind: InputFunctionCallType,
...
#[derive(ToSchema, Debug, Serialize, Deserialize, Clone, PartialEq)]
pub enum InputFunctionCallType {
    #[serde(rename = "function_call")]
    FunctionCall,
}

/// The output of a function call executed by the client.
#[derive(ToSchema, Debug, Serialize, Deserialize, Clone, PartialEq)]
pub struct InputFunctionCallOutput {
    /// Must be "function_call_output".
    #[serde(rename = "type")]
    pub kind: InputFunctionCallOutputType,
    /// The call_id of the function call this output corresponds to.
    pub call_id: String,
    /// The output of the function call (a JSON string or plain text).
    pub output: String,
    /// Optional unique ID for this item.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
...
#[derive(ToSchema, Debug, Serialize, Deserialize, Clone, PartialEq)]
pub enum InputFunctionCallOutputType {
