...
//!
//! ```
//! use dynamo_async_openai::{Client, config::OpenAIConfig};
//!
...
//!
//! use dynamo_async_openai::{Client, types::{CreateCompletionRequestArgs}};
//!
//! // Create client
//! let client = Client::new();
//!
...
//! For example,
//! ```
//! use dynamo_async_openai::{Client, config::Config, config::OpenAIConfig};
...
//!
//! ```
//! use dynamo_async_openai::{Client, config::AzureConfig};
//!
