...
// Source: mock/model.rs inline tests
// TODO: Disabled — tests use MockModelRunner which itself is fine, but the test module
// contains references through the parent's Scheduler dependencies. The model itself
// has no Scheduler dependency; these tests can be re-enabled independently.
#[cfg(test)]
mod tests {
    use super::*;
