...
#[cfg(TODO)]
use kvbm_engine::testing::managers;
#[cfg(TODO)]
use kvbm_engine::testing::token_blocks;

// Source: create_test_scheduler
// TODO: Disabled — depends on v2::integrations::scheduler::{KVCacheManager, Scheduler, SchedulerConfig}
// which has no workspace equivalent in this phase. Re-enable when integrations/scheduler is ported.
#[cfg(TODO)]
...
// Source: create_test_request
// TODO: Disabled — depends on v2::integrations::common::Request which has no
// workspace equivalent in this phase. Re-enable when integrations/scheduler is ported.
#[cfg(TODO)]
...
// Source: create_test_request_with_salt
// TODO: Disabled — depends on v2::integrations::common::Request
#[cfg(TODO)]
...
// Source: create_test_scheduler_with_connector
// TODO: Disabled — depends on v2::integrations::scheduler::{KVCacheManager, Scheduler, SchedulerConfig}
#[allow(dead_code)]
#[cfg(TODO)]
...
// Source: get_connector_leader
// TODO: Disabled — depends on v2::integrations::connector::leader::ConnectorLeader
#[allow(dead_code)]
#[cfg(TODO)]
pub fn get_connector_leader(instance: &TestConnectorInstance) -> std::sync::Arc<ConnectorLeader> {
    instance.leader.clone()
}

// Source: populate_prefix_cache
// TODO: Disabled — depends on v2::integrations::scheduler::{Scheduler, RequestStatus}
#[allow(dead_code)]
#[cfg(TODO)]
...
// Source: mod tests
// TODO: Disabled — entire test module uses v2::integrations::scheduler::Scheduler which has
// no workspace equivalent in this phase. Re-enable when integrations/scheduler is ported.
#[cfg(TODO)]
mod tests {
    use super::*;
    use kvbm_engine::testing::managers;
