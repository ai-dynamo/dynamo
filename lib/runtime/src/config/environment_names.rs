...
pub mod event_plane {
    /// Event-plane selection: "zmq" or "nats".
    ///
    /// When unset, the default is `zmq`. Valkey routing metadata is configured
    /// independently and is not a generic event-plane transport.
