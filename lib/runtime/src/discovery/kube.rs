...
impl Discovery for KubeDiscoveryClient {
    ...
    async fn unregister(&self, instance: DiscoveryInstance) -> Result<()> {
        ...
        tracing::debug!(
            "Unregistering instance: {:?} with instance_id={:x}",
            instance,
            instance_id
        );
        ...
        match &instance {
            DiscoveryInstance::Endpoint(inst) => {
                tracing::info!(
                    "Unregistered endpoint: namespace={}, component={}, endpoint={}, instance_id={:x}",
                    inst.namespace,
                    inst.component,
                    inst.endpoint,
                    instance_id
            ...
            DiscoveryInstance::Model {
                ...
                tracing::info!(
                    "Unregistered model card: namespace={}, component={}, endpoint={}, instance_id={:x}",
                    namespace,
                    component,
                    endpoint,
                    instance_id
