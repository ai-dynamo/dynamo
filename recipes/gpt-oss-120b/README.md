...
3. **Air-gapped clusters only** — stage the Harmony vocabulary file. The frontend parses gpt-oss
   reasoning and tool calls with `o200k_base.tiktoken`, which it otherwise downloads on first use from
