...
| Model | Framework | Mode | GPUs | Deployment | Notes |
|-------|-----------|------|------|------------|-------|
| **[GPT-OSS-120B](gpt-oss-120b/vllm/agg-snapshot-gms/)** | vLLM | Aggregated + GMS Snapshot | 1x B200 | ✅ | Experimentally validated with a main-branch nightly. Requires locally built Snapshot images and POSIX RWX checkpoint storage. |
