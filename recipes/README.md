...
| **[Qwen3.5-122B-A10B-FP8](qwen3.5-122b/fp8/vllm/agg-h200-agentic/)** | vLLM | Aggregated | 2x H200 | ✅ | ✅ | Hybrid GDN+MoE, TP1 x `replicas: 2`, MTP spec decode, KV-aware routing; agentic profile | ❌ |
