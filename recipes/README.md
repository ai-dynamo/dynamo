...
| **[GLM-5.2-NVFP4](glm-5.2/)** | SGLang | Disagg Prefill/Decode | 12x B200 | ✅ | ✅ | NVFP4 + FP8 KV, TP4 prefill + TP8 decode, NIXL/UCX, KV-aware routing, EAGLE, HiCache CPU offload, agentic trace profile | ❌ |
