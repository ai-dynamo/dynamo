...
| **[GLM-5.2-NVFP4](glm-5.2/)** | SGLang | Aggregated + Disaggregated | 4x or 12x B200 | ✅ | ✅ | NVFP4 + FP8 KV, TP4 aggregate or TP4 prefill + TP8 decode, KV-aware routing, EAGLE, HiCache CPU offload, agentic trace profile | ❌ |
