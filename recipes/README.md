...
Update the `containers.epp.image` value in `llama-3-70b/vllm/agg/gaie/deploy.yaml`. It should match the Dynamo release tag and use the public EPP image, for example `nvcr.io/nvidia/ai-dynamo/dynamo-frontend:1.3.0-dev.1`.
