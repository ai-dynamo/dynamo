...
| **[GLM-5.1-FP8](glm-5.1-fp8/vllm/disagg/)** | vLLM | Disagg Prefill/Decode | 32x GB200 | ✅ | FP8 E4M3, 256-expert MoE, 202K context, 2×TP8 prefill + 2×TP8 decode, NIXL KV transfer, reasoning + tool calling, MNNVL ComputeDomain. |
