...
| **[GLM-5.2](glm-5.2/)** | SGLang | Aggregated + Disaggregated | 4x/12x B200 or 8x/16x H200 | ✅ | ✅ | B200 NVFP4 or H200 FP8 with FP8 KV, KV-aware routing, EAGLE, B200 HiCache CPU offload, agentic trace profile | ❌ |
