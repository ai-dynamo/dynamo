#!/bin/bash
#SBATCH --job-name=core_dlfw_ci-benchx.4ctx1gen.dynamo.kvrouter.newcfg
#SBATCH --nodes=2
#SBATCH --partition=gb200
#SBATCH --account=core_dlfw_ci
#SBATCH --time=04:00:00
#SBATCH --output=bench/logs/run_benchx_4ctx1gen_dynamo_kvrouter_new_config_%j.log
#SBATCH --error=bench/logs/run_benchx_4ctx1gen_dynamo_kvrouter_new_config_%j.err
...
#
# Submit:
#   sbatch --export=ALL,CONCURRENCY=48,HOSTCACHE=0,WORKER_METRICS=0 bench/run_benchx_4ctx1gen_dynamo_kvrouter_new_config.sh
# =============================================================================
...
EXP_NAME="run_benchx_4ctx1gen_dynamo_kvrouter_new_config_${HCTAG}_c${CONCURRENCY}"
