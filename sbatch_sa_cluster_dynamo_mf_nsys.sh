...
DYNAMO_WORKER_ENV="export ETCD_ENDPOINTS=http://${HEAD_NODE}:${ETCD_PORT} && export NATS_SERVER=nats://${HEAD_NODE}:${NATS_PORT} && export DYN_REQUEST_PLANE=${DYNAMO_REQUEST_PLANE} && export DYN_TCP_WORKER_POOL_SIZE=${DYN_TCP_WORKER_POOL_SIZE} && export DYN_TCP_WORK_QUEUE_SIZE=${DYN_TCP_QUEUE_SIZE} && export DYN_TCP_POOL_SIZE=${DYN_TCP_POOL_SIZE} && export DYN_NVTX=1"
