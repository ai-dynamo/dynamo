...
from benchmarks.coding.claude_discovery import discover_trace_files
...
def main() -> int:
    ...
    sessions = load_trace_records(trace_files)
    if not sessions:
        raise ValueError(
    ...
    mooncake_rows = build_mooncake_rows(all_turns, tokenizer, args.block_size)
