...
def print_final_summary(output_dir: str, labels: List[str]) -> None:
...
def run_benchmark_workflow(
    ...
    for label, endpoint in inputs.items():
        run_endpoint_benchmark(label, endpoint, model, isl, osl, std, output_dir)
        benchmarked_labels.append(label)

    # Generate final summary
    print_final_summary(output_dir, benchmarked_labels)
