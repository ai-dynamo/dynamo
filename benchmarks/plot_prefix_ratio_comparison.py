...
def create_comparison_plots():
    ...
    dataset_configs = [
        (
            "push_load/kv/results_summary.json",
            "Kv Router",
            "c-s",
            None,
        ),
        (
            "push_load/kv_2/results_summary.json",
            "Kv Router (2 replicas)",
            "r-o",
            None,
        ),
        (
            "push_load/kv_2_shared/results_summary.json",
            "Kv Routers (2 replicas, states shared)",
            "b-D",
            None,
        ),
        # (
