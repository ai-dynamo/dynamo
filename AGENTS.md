...
5. The production profile uses the combined SGLang HiSparse + IndexCache + dense TurboQuant path. Keep HiCache disabled unless the HiSparse no-radix contract is deliberately reworked and revalidated.
