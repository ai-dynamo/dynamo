...
Follow the [Agent Instruction Files](#agent-instruction-files) convention at each
scope. When a nested guide and a broader one both apply, the nested one wins.
