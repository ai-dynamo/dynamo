...
- [x] **Phase 2: Import Migration** - Replace all stale internal imports with correct workspace crate paths and migrate nova to velo (completed 2026-03-11)
- [x] **Phase 3: Compilation Gate** - Verify the crate and full workspace compile cleanly (completed 2026-03-11)
...
Plans:
- [x] 01-01-PLAN.md — Register workspace members, populate kvbm-connector Cargo.toml dependencies and testing feature
...
Plans:
- [x] 02-01-PLAN.md — Pass 1-3: Replace crate::logical::*, crate::physical::*, and crate::distributed::* imports
- [x] 02-02-PLAN.md — Pass 4-5: Replace crate::v2::* imports and resolve crate::integrations::* self-refs
- [x] 02-03-PLAN.md — Pass 6: Complete nova→velo sweep (directory rename, type renames, runtime.nova→messenger)
- [x] 02-04-PLAN.md — Gap closure: rename ForwardPassNovaEvent and remaining Nova identifiers/comments
...
Plans:
- [x] 03-01-PLAN.md — Declare nccl feature in kvbm-connector Cargo.toml and verify clean compilation
...
Plans:
- [x] 04-01-PLAN.md — Update Cargo.toml (figment dep, tracing-subscriber dev-dep, testing feature), wire lib.rs and testing/mod.rs skeleton
- [x] 04-02-PLAN.md — Port testing/connector.rs (~1756 lines) with import migration, activate pub mod connector
- [x] 04-03-PLAN.md — Port testing/e2e/ (3 files) and testing/scheduler/ (8 files), disable Scheduler-dependent tests
- [x] 04-04-PLAN.md — Restore worker/tests.rs imports, run full cargo test, achieve green suite
...
| 2. Import Migration | 4/4 | Complete | 2026-03-11 |
| 3. Compilation Gate | 1/1 | Complete | 2026-03-11 |
