...
# Keep the upstream SGLang Python solve intact: install only the Dynamo-owned
# wheels and suppress transitive dependency resolution unless validation later
# proves a small explicit add-back is required.
