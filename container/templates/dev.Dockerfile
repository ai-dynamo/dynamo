...
# - SGLang: Copy NIXL/UCX/gdrcopy binaries from wheel_builder (not in upstream
#   lmsysorg/sglang runtime). EFA images install their pinned libfabric later in
#   the shared aws stage; non-EFA images intentionally carry no OFI runtime.
