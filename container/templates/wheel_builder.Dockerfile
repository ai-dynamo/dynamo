...
# images cannot combine artifacts from different revisions.
...
# Downstream images install these local artifacts instead of resolving the older
# monolithic upper distribution from the index.
