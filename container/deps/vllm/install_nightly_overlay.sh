...
readonly EXPECTED_VLLM_REF=274603f228c16a7b899fe22eb109c5f49f105696
readonly EXPECTED_VLLM_HEAD=274603f228c16a7b899fe22eb109c5f49f105696
readonly EXPECTED_FLASHINFER_URL=https://github.com/flashinfer-ai/flashinfer.git
readonly EXPECTED_FLASHINFER_REF=refs/pull/3950/head
readonly EXPECTED_FLASHINFER_SHA=243d56c12cf1c724bdb128a4575ebf6ce1e8a1a9
...
validate_overlay_source() {
    ...
    [[ "$(git -C "${source}" rev-list --count "${EXPECTED_BASE_COMMIT}..HEAD")" \
        == 1 ]] || die "vLLM overlay must contain exactly one commit"
...
vllm_overlay_commits=1
vllm_overlay_files=5
