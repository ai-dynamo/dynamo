#!/bin/bash
#SBATCH --job-name=coreai_comparch_aarwlt-benchx.4ctx1gen.dynamo.kvrouter
#SBATCH --nodes=1
...
#
# Layout:
#   NODE0 — etcd + nats + dynamo frontend + 4 ctx worker(s) (GPUs 0-3) + 1 gen worker(s) (GPUs 4-4)
#
...
# --- 1 gen worker(s) on $NODE0 GPUs 4-4 (decode) ---
GEN_PIDS=()
for GPU in 4; do
