...
"""Sweeper only configures process-wide JAX state when a sampler is requested."""
...
def test_import_sweeper_has_no_jax_process_side_effects():
    _run_isolated("""
        ...
        import aisimulate.sweeper as sweeper

        assert sweeper.__name__ == "aisimulate.sweeper"
...
def test_configure_vizier_runtime_is_explicit_opt_in():
    _run_isolated("""
        ...
        os.environ.pop("JAX_PLATFORMS", None)
        from aisimulate.sweeper._quiet import configure_vizier_runtime
