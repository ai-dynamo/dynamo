...
use aisimulate_engine::generalized::{PassId, SameTimestampRetry, SchedulerCommand};
...
use crate::engine::ReplayRoleFactory;
    ...
    Observation: ReplayEngineObservation,
{
    ...
    pub(crate) fn apply_command(
        ...
        let effects = self
            ...
            .map_err(crate::error::engine_boundary)?
            .into_by_rank()
            .into_iter()
            .next()
...
mod tests {
    use super::*;
    use crate::{ReplayEngineConfig, ReplayEngineFactory, WorkerStage};
    use aisimulate_engine::{Backend, EngineConfig, KvEvent, SglangConfig, TimingModelConfig};
