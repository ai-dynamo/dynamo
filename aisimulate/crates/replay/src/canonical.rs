...
use crate::{
    OfflineRuntimeEvidence, PerRequestRecord, ReplayCaptureOptions, TraceDistributionStats,
...
pub struct CanonicalReplayCoverage {
    ...
    pub pressure: Option<crate::PressureEvidence>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kv_ingest: Option<crate::KvIngestEvidence>,
}

impl CanonicalReplayCoverage {
    pub fn from_report(report: &TraceSimulationReport, options: ReplayCaptureOptions) -> Self {
        Self {
