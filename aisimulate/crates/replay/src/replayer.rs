...
use crate::engine::{ReplayEngineConfig, ReplayEngineFactory};
use crate::error::{placement_boundary, runtime_error, scaling_boundary};
    ...
    P: PlacementPolicy<Request>,
{
    ...
    fn place(
        ...
        now_ms: f64,
    ) -> AnyResult<crate::core::PlacementEffects> {
        self.0
    ...
    fn observe(
        ...
        now_ms: f64,
    ) -> AnyResult<Vec<crate::core::Placement>> {
        self.0
    ...
    fn topology_settled(&mut self, now_ms: f64) -> AnyResult<Vec<crate::core::Placement>> {
...
impl ReplayScalingPolicy for ScalingPolicyBoundary {
    ...
    fn on_tick(
        &mut self,
        snapshot: crate::scaling::ReplayScalingSnapshot,
    ) -> AnyResult<crate::scaling::ReplayScalingDecision> {
