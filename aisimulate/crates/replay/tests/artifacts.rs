...
use aisimulate_engine::{Backend, EngineConfig, KvEvent, TimingModelConfig};
use aisimulate_replay::loadgen::{SessionTrace, Trace, TurnTrace, WorkloadDriver};
use aisimulate_replay::{
    ...
    ReplayEngineFactory, ReplayRuntimeInput, ReplaySpec, ReplayTopology, Replayer,
    RoundRobinComposition, TraceSimulationReport, WorkerPoolSpec,
};
...
) -> (TraceSimulationReport, ReplayArtifacts) {
