        ...
        sglang: Some(SglangArgs {
            schedule_policy: Some(
                match config.sglang.schedule_policy {
                    crate::SglangSchedulePolicy::Fifo => "fifo",
                    crate::SglangSchedulePolicy::Lpm => "lpm",
                }
                .to_string(),
            ),
...
fn split_pass(
    ...
    crate::generalized::SameTimestampRetry,
    PassStartEffects,
...
fn map_fpm(fpm: crate::common::protocols::ForwardPassSnapshot) -> ForwardPassMetrics {
    ForwardPassMetrics {
...
mod tests {
    ...
    use super::*;
    use crate::{PressureKind, TimingModelConfig};
