...
from .adapter import AdapterReplaySpec, JSONValue, RuntimeHookSpec
...
@dataclass(frozen=True)
class ReplaySpec:
    """Strict data boundary between Spica and an injected replay runner."""
...
@dataclass(frozen=True)
class ReplayReport:
    """Runner output consumed by Spica scoring."""
...
class RunnerCapabilities:
    ...
    def require_replay_spec_version(
        ...
        """Raise when the runner and Spica do not share the replay-spec ABI."""
