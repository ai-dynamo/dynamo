...
- Codex inline review kept reviewer lifecycle items on the root thread, then that same thread completed a later shell-tool turn with a file effect: `/ephemeral/harness-compat-artifacts/20260801T1735Z-codex-inline-review`.
