#!/bin/bash
#SBATCH --job-name=coreai_comparch_aarwlt-benchx.4ctx1gen_tp4.dynamo.kvrouter
#SBATCH --nodes=1
...
# =============================================================================
# benchx (feat/bench_x sha 11e16c) — 4 ctx TP1 + 1 gen TP4 with kv router,
...
#
# Submit:
#   sbatch --export=ALL,HOSTCACHE=0,WORKER_METRICS=0 bench/run_benchx_4ctx1gen_tp4_dynamo_kvrouter.sh
...
EXP_NAME="run_benchx_4ctx1gen_tp4_dynamo_kvrouter_${HCTAG}_c${C_TAG}"
