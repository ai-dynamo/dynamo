...
Changes to a public API, to communication plane architecture, to backend integration contracts, or spanning multiple areas also require a [Dynamo Enhancement Proposal](https://github.com/ai-dynamo/enhancements) before they land. A DEP is sponsored by the Special Interest Group covering the affected areas, acting through a Co-Lead or an area Maintainer, reviewed by the Maintainers of every area it touches, and approved by a two-thirds vote of the Core Maintainers. Take the idea to the SIG before writing the proposal. Once it is approved, the pull requests implementing it link the DEP and skip the Contribution Request, though they still need their code owners and two approvals.
