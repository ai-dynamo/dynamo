...
"""Fixture generator for the parser-parity harness.
...
a container with dynamo._core installed:
    ...
    python3 tests/parser_parity/fixtures/_generate.py

Re-running overwrites existing fixtures. Edit INPUTS to add or change
templates; the generator captures Dynamo's output verbatim, so
fixtures always reflect the current Rust contract.

Cases generated per family follow PARSER_CASES.md. N/A combinations
...
INPUTS: dict[tuple[str, str], dict[str, Any] | None] = {
    ...
    ("qwen3_coder", "PARSER.batch.4"): {
        "description": "Malformed (missing closing tag)",
        "text": "<tool_call>\n<function=get_weather>\n<parameter=location>\nNYC\n</parameter>\n</function>",
        "tools": [_GET_WEATHER_LOC],
    },
