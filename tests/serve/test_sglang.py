...
sglang_configs = {
    ...
    "disaggregated_variable_tp": SGLangConfig(
        name="disaggregated_variable_tp",
        directory=sglang_dir,
        script_name="disagg.sh",
        script_args=["--prefill-tp", "1", "--decode-tp", "2"],
        marks=[pytest.mark.gpu_4],
        model="Qwen/Qwen3-0.6B",
        env={},
        models_port=8000,
        request_payloads=[chat_payload_default(), completion_payload_default()],
    ),
    "disaggregated_tp_pp": SGLangConfig(
        name="disaggregated_tp_pp",
        directory=sglang_dir,
        script_name="disagg.sh",
        script_args=["--prefill-tp", "2", "--prefill-pp", "2", "--decode-tp", "2"],
        marks=[pytest.mark.gpu_8],
        model="Qwen/Qwen3-0.6B",
        env={},
        models_port=8000,
        request_payloads=[chat_payload_default(), completion_payload_default()],
