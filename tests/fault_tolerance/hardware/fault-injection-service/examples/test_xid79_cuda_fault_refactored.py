...
def test_xid79_with_cuda_fault_injection(cleanup_on_exit):
    ...
    try:
        ...
        print("    NVSentinel syslog-health-monitor will detect this")
        ...
        label_selector = f"nvidia.com/dynamo-component-type=worker,nvidia.com/dynamo-graph-deployment-name={TARGET_DEPLOYMENT}"
        crashed = cuda_injector.wait_for_pods_to_crash(
            NAMESPACE, label_selector, target_node, timeout=420
        )
        ...
        print("    (Equivalent to draining in production)")
