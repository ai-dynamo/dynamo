...
def run_aiperf(
    ...
    for attempt in range(max_attempts):
        ...
        try:
            ...
            ## TODO: aiperf bug where sending a SIGINT on Mac can sometimes have an error code of -9 (SIGABRT) which results in profile_export_aiperf.json not being created
