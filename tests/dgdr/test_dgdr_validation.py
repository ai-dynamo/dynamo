...
class TestDGDRValidation:
    ...
    def test_v1beta1_is_storage_version(self, dgdr_namespace: str) -> None:
        ...
        assert "v1beta1" in result.stdout, (
    ...
    def test_kubectl_get_columns_schema(self, dgdr_namespace: str, dgdr_image: str, dgdr_model: str, dgdr_factory) -> None:
        """
        ...
        header = result.stdout.splitlines()[0].upper() if result.stdout.splitlines() else ""
...
class TestDGDRVersionConversion:
    ...
    def test_v1alpha1_dgdr_can_be_applied(self, dgdr_namespace: str, dgdr_image: str, dgdr_model: str, dgdr_factory) -> None:
        """
    ...
    def test_v1beta1_get_on_v1alpha1_object(self, managed_dgdr: ManagedDGDR, dgdr_namespace: str, dgdr_image: str, dgdr_model: str, dgdr_factory) -> None:
        ...
        if result.returncode == 0:
            ...
            assert obj_v1alpha1["apiVersion"] == "nvidia.com/v1alpha1", (
