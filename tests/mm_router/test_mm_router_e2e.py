...
@pytest.mark.timeout(1800)
@pytest.mark.nightly
def test_trtllm_mm_overlap_repeated_http_images(
    start_trtllm_mm_services, predownload_models, http_image_server
):
...
@pytest.mark.timeout(1800)
@pytest.mark.nightly
def test_trtllm_mm_overlap_http_vs_data_uri_same_image(
    start_trtllm_mm_services, predownload_models, http_image_server
):
