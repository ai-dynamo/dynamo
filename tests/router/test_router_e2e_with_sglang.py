...
@pytest.mark.parametrize(
    ...
    [
        ("etcd", True, "nats"),  # JetStream mode
        # ("etcd", False, "tcp"),  # nats_core mode - disabled for now
        # ("file", True, "nats"),  # File backend - TODO: investigate file backend support for SGLang
    ],
    ids=["jetstream"],
