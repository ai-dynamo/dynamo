...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            classification_cache_ttl_hours=int(os.getenv("CLASSIFICATION_CACHE_TTL_HOURS", "168")),
            min_confidence_for_reuse=float(os.getenv("MIN_CONFIDENCE_FOR_REUSE", "0.8")),
            enable_realtime_classification=os.getenv("ENABLE_ERROR_CLASSIFICATION", "").lower() == "true",
            classify_realtime_threshold=os.getenv("CLASSIFY_REALTIME_THRESHOLD", "infrastructure"),
        )
